...
This method  does half the job of  \prg{transfer}, then calls "outside", and then does the rest. Was meant to demo proof of preservation of currency. Proof ot pre- and post in the presence of unknown.
