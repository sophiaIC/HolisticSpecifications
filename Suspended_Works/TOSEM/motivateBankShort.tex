...
We will not show the code  here (see appendix~\ref{Bank:appendix}), but suffice it to say that class 
...
Moreover, \prg{deposit} requires that the receiver and
...
One obvious solution would be to adopt %return to 
a closed-world
...
However, requirement  (1) is not enough to protect our money. We need (2) to avoid an \prg{Account}'s balance getting
