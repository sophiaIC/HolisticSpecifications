...
Expressions may appear within assertions, and 
 as the bodies of ghost field definitions \appref{def:syntax:classes}.
...
\susan{I changed this paragraph because it didn't make sense - please check}\kjx{LGTM. sd?}
