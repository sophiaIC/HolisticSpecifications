...
\prg{Wrapper} objects can  attenuate the use of 
\prg{Node}s.
The
function \prg{usingWrappers} takes as parameter an object of unknown
...
\scd{Shell we say the following, or does it break the flow? \\
