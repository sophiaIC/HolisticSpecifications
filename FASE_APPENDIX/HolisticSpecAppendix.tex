...
\begin{abstract}
This is the appendix to a paper of same title which will be
appear at FASE 2020.
...
In the FASE paper we
 ...
 give a formal semantics for \Chainmail, and the core of \Chainmail has been
  ...
  In this appendix we give all the definitions belonging to our FASE paper, and
  discuss a sequence of examples.
