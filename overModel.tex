...
\kjx{commented out/moved stuff into LangOO model section, sophia should check}
%% \sd{As a notational convenience, we keep the code to be executed as part of the runtime configuration.
