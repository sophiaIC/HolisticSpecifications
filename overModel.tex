...
%
%
\sd{To} % skipped the discussion of what a module is
...
\sd{Satisfaction is also  judged 
in the context of modules; these are used to find    abstract functions defining ghost fields as well as  method bodies
...
where we ignore all intermediate steps
 \sd{with receivers  internal to $\M$. }
