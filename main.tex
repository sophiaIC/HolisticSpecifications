...
In this open world ensuring that your component is robust even when executing with buggy or malicious external code is critical.
 \emph{Holistic specifications}\sophia{Why do holistic specs imply necessary?}
...
programmers can explicitly define what their programs should not do\sophia{Wr need to argue that it is important to know
