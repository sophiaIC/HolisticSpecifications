...
Most specifications of program components describe what
...
\susan{the failures we discuss - steal and stealing from acm-acc, aren't what I think of as non-functional behaviour - for example running too slowly}
nonfunctional (systemic) behaviours of
 partial programs in an open
world where security, privacy, robustness, and reliability are as
important as functional behaviours. \emph{Holistic specifications}
...
While specifications may be enough to reason about the behaviour of
...
\section{Summary of Underlying Programming Language Semantcis}
\label{sect:PL}
\input{summaryExecution}

\section{Assertions -- full Defintions}
