...
\label{sect:motivate:DOM}
\input{motivateBank}


\input{foundations}

\section{Another Example -- Attenuating the DOM}\sdcomment{This section now needs to be updated, as it has moved to later in the paper}
\label{sect:motivate:DOM}
