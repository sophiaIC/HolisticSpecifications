...
\sd{In this paper we argue \se{for} the need for such holistic specifications,
 propose a %specification 
 language \se{\Chainmail} for \se{writing } specifications, give a formal semantics, and discuss several
