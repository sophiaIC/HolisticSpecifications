...
\subsubsection{Mid-conditions and Substructural Rules}
...
Polymorphic Calls.} Our rules do  not \emph{directly} address scenaria where  the receiver may be
   internal or external, andthe choice about this is made at runtime. 
...
\subsection{Third Phase: Adherence to Module Specifications}
\label{sect:wf}
