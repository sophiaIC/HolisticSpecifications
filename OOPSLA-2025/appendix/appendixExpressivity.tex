...
With this approach, \prg{Alice} can pass to \prg{Bob} a \prg{Caretaker} to \prg{Carol}, and retain the \prg{Gate}. 
...
module WithRevocation
   class Gate
         ...
         private method init(t: Target): void
         	this.caretaker  := new Gate
	        this.caretakertarget := t
   ...
   class Caretaker
         ...
         public method forward(mssg: Message): void
            if (this.enabled) then
               target.mssg()    / / calling mssg on target
