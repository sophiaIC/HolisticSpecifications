...
\title{Reasoning about External Calls -- Extended Version}

\titlenote{This extended version of our work contains an appendix with full formal definitions, examples, more explanations, and worked out proofs. Citations should use the original version of the paper, \cite{ExternalCallsOOPSLA22}.} 
...
\affiliation{
  ...
  \institution{Kry10 Ltd, and Victoria University of Wellington}           %% \institution is required
