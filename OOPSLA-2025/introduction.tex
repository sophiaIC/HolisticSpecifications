...
% for which we don't have the source nor a specification.
...
%at line 6 it 
and calls an unknown external method \prg{unkn} passing itself as an argument. 
...
\afull{in the extended version of this work \cite{externalCallsFull}.}{of this paper.}
