...
As in \citet{ELang},   \prg{Account}s belong to \prg{Bank}s and hold money (here \prg{balance}s);  
...
implicilty gives   that \prg{o} is external}
...
\susan{I think having 1 and 2 would make it more complicated. You
could have a footnote though that says actually you don't even need 3
as it is a corollary of 2}
