...
\authorrunning{S. Drossopoulou, J. Mackay, et al.}
...
%rgue for the need for such holistic specifications,
 propose a 
 language \Chainmail for writing \emph{holistic} specifications fit for open world scenarios that
 focus on necessary conditions (as well as sufficient conditions). We give a formal semantics, the
 core of which has been
