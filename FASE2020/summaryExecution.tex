...
\sophia{We define {\em initial configurations}, whose heap  have only one object, of class \prg{Object}, and whose stack} have one frame, with arbitrary continuation.
