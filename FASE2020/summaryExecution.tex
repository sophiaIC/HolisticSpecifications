...
This would correspond to an atomic evaluation in the two-module execution: \  \
 $\M_{BA2}\mkpair \M', \sigma_4 \ \leadsto \sigma_5$ (see Fig.\ref{fig:VisibleStates}; \ {where we use blue states when $\sigma(this)\!\in\!M_1$,%
   and  orange states when $\sigma(this)\!\in\!M_2$}).
