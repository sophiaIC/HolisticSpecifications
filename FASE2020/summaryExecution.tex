...
This would correspond to an atomic evaluation in the two-module execution: \  \
 $\M_{BA2}\mkpair \M', \sigma_4 \ \leadsto \sigma_5$ (see Fig.\ref{fig:VisibleStates}; \sdN{where blue states when $\sigma(this)\!\in\!M_1$,%
    orange states when $\sigma(this)\!\in\!M_2$}).
