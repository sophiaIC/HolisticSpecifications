...
Consider the code snippets from fig. \ref{fig:ExampleSafe}. Objects of
 ...
 the holder of the secret can  \kjx{remove the treasure from the safe}.
%
...
% but we don't! 
 ...
 \sd{We assume that fields are private in the sense \kjx{of Java}, \ie only
 methods of that class may read or write these fields;
 and that addresses are unforgeable, so  there is mo way to guess a secret.}
