 In this section we present the properties of Chainmail that have been formalised in the Coq model. Table \ref{Coq} refers to proofs that can be found in the associated Coq formalism \cite{coq}.
