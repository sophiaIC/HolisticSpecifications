...
\newcommand{\jncomment}[1]{{\ensuremath{\blacksquare}}\footnote{\kjx{#1}}}
 ...
 \newcommand{\sd}[1]{{\color{dkgreen}{#1}}}% {#1} %
...
\sd{They allow us to reason about the  use  of  
...
However,  sufficient conditions are not enough to reason about 
the use of components in \sd{the \emph{open world} setting, where
...
%
In this paper we
%rgue for the need for such holistic specifications,
 propose a 
...
\end{document}  %% IGNORE THE APPENDICES FOR NOW!
