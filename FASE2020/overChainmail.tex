...
{\Future {\A}} {\SF}$  requires two things: i) that $\A$ will hold in
the future, and ii)  that all the objects which cause the effect which will make $\A$ valid are   included in \SF.
