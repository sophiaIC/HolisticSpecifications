...
\kjx{slightly revised (fewer parens):\\
\noindent
 \strut \hspace{0.5cm} $\forall \prg{d}:\prg{DAO}.\forall \prg{p}:\prg{Any}.\forall\prg{m}:\prg{Nat}. \ \prg{d.balances(p)}=\prg{m}  \ \ \  \longrightarrow  \ \ \ \prg{d}.\prg{ether}\geq \prg{m} \ \  $
}

\kjx{clearer but requires $\Sigma$:\\
\noindent
 \strut \hspace{0.5cm} $\forall \prg{d}:\prg{DAO}.\forall \prg{p}:\prg{Any}.\ \ \Sigma\ \prg{d.balances(p)} \leq \prg{d.ether} $
}
