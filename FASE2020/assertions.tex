...
\kjx{\Chainmail Assertions consist of (pure) expressions \e, classical
...
%when giving necessary conditions for some future effect.
 ...
 In general, $\Future {\Using {\A} {\SF}}$ is different from
  ...
  For example, revisit Fig. \ref{fig:BankSpec}, and take $\SF_1$ to consist of objects \prg{1}, \prg{2},   \prg{4}, \prg{93}, and \prg{94},
