...
have the same necessary  condition to the invalidation of that assertion, then 
...
{states that 
if   $A'$ is a necessary condition for the satisfaction of $A$ to change  in \emph{one} step, then
