...
\definecolor{darkgreen}{rgb}{11,102,35}
\newcommand{\sdS}[1]{\textcolor{cadmiumgreen}{#1}\xspace}
...
%%%% by Sophia Drossopoulou, Susan Eisenbach, James Noble, and Julian Mackay.
%%%%
\setcopyright{rightsretained}
\acmPrice{}
...
%\setcopyright{rightsretained}
%\acmJournal{PACMPL}
%\acmYear{2022} \acmVolume{6} \acmNumber{OOPSLA2} \acmArticle{154} \acmMonth{10} \acmPrice{}\acmDOI{10.1145/3563317}
...
\begin{acks}                            
  ...
  Rachar,  Alexander J.  Summers, and members of the WG2.3.
