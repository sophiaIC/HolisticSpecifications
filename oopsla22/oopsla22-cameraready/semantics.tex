...
\jm[]{the appendices of the full paper \cite{necessityFull} contains}
...
Full details in \jm[]{the appendices of the full paper \cite{necessityFull}.} %Appendix \ref{app:loo}.
\begin{figure}[htb]
