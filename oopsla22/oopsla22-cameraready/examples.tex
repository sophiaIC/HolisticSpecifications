...
A {summary} of this proof has already been discussed in \S \ref{s:approach}.
 A more complex variant of this example can be found in the appendices of the full paper \cite{necessityFull}. %Appendix \ref{app:examples}.
 ...
 several fields.} \julian{Mechanised versions of the proofs in both this Section, and \jm[]{the appendices of the full paper \cite{necessityFull}} %Appendix \ref{app:examples}
 can be found in the associated Coq artifact \cite{necessityCoq2022} in \prg{simple\_bank\_account.v} and \prg{bank\_account.v} respectively.}
...
We use \sdNr[used to say "a conservative approach to an encapsulation system" but "conservative" here means sound]{a simple encapsulation system}, detailed in the full paper with appendices \cite{necessityFull}, 
