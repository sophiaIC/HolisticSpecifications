...
\kjx{has moved things around through here}
...
\susan{These features sort of come from nowhere, so I wonder whether
we even want them in the introduction. I think if you do then
something more about open systems, (that what is critical is
controlling access from foreign code and that you need to be able to
talk about that in the specification language) should come
first.}\kjx{jI tried to link them in a bit more}
\begin{description}
...
\kjx{moved around --- not sure we need this para}
Formally, holistic assertions typically have the form of a guarantee
