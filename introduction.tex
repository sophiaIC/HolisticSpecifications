...
to obtain access to our bank details\cite{cwe}. \susan{I put in the ERC20 citation but I don't see what that has to do with banks authorising payments}
...
\susan{do we really need a citation for constants and private? - if we do then do you mind just the Java language}
