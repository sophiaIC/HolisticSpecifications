...
%
%\begin{description}
\susan{I think having bullets within text doesn't look good - it just looks like you don't have the room to put bullet points}
\james{I agree}
%\item[Permission] 
...
%\sophia{the first 4 sentences of this
...
not done yet. Do you think not?}\james{not the last one (yet), the other quetsion is whether we should be more specific noveltiers (viewpoint semantics; ghost-step-indexing, etc)}
\begin{itemize}
