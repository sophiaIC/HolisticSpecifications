...
a patient needs to  know that  will be no passing of their health data to their employer  
unless they   authorized this; \sophia{changed example, as what we had 
here was identical to that if earlier paragraph.}
the explicit authorization by the the patient themselves  is the
...
\sophia{I do not know who wrote the comparison wih foorprints, but it looks good to me.}
