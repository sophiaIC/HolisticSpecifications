...
\paragraph{\sd{Alternative diagram and text}}
...
implication of putting assertions from necessary and sufficient conditions: 
...
\paragraph{\sd{Continue here} } Necessary conditions are guarantees upheld throughout program execution.
In this way, 
