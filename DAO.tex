The DAO \se{(Decentralised Autonomous Organisation)}~\cite{Dao}  is a famous Ethereum contract  which aims to support
...
%\footnote{cite ghost fields}:\james{seecomments about ghost fields in ERC20}
...
\se{If a previous call was \prg{p} joining  a DAO \prg{d} and paying in \prg{m} then the balance of \prg{p} is \prg{m}.}
