...
which might make it possible to create "free" money, \Mrr[Is this explicit enough?]{as shown with \prg{freeMoney} on the right in fig.~\ref{fig:ExampleBank}, a situation any sensible bank implementation should avoid.} In fact it would be impossible to express such a restriction using a classical specification. For this, we \Mrr[As per S.D. request]{propose} \emph{holistic specifications}, and require that:
