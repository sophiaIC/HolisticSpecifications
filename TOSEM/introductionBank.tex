...
We relegate various details to appendices. An earlier version of this paper appeared at FASE 2020. The main extensions are the problem-driven design, the further discussion of the Bank and the specification of \LangOO (appendices are not part of the FASE paper) and the main changes are to the introduction.
