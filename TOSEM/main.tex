...
\scd{In addition to necessary conditions} which describe what is enough to \emph{cause} some effect,
...
and includes  semantics as well as several case studies. \scd{It also reports on the mechanisation of the proofs of several properties of
 \Chainmail, as well several examples' adherence to their holistic specifications.}
