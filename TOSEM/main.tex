...
In earlier work we proposed the \Chainmail specification language. Our further mechanisation of proofs has led us to simplify some of our original design decisions. This paper contains a more extensive account of \Chainmail's features and includes both a semantics and several case studies.
\end{abstract}
