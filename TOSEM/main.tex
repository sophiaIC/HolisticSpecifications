...
\Mrr[Is this what we're looking for, or do we want to say more?]{In earlier work we proposed the \Chainmail specification language. In this paper we give a more extensive account of its features and use cases, and improve upon the design decisions.}
\end{abstract}
