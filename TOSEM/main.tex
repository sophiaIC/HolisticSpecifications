...
\mrr[ensuring that your component is robust even when executing
...
what is enough to \emph{cause} some effect, as well as with]{Readded this to the abstract, assuming this was left in the comments as "desirable" but not practical due to page limits}
