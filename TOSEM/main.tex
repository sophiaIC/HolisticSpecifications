...
\Mrr[Is this what we're looking for, or do we want to say more?]{In earlier work we proposed the \Chainmail specification language and its semantics. In this paper with give a more extensive account of its features and use cases, and improve upon the design decisions.}
\end{abstract}
