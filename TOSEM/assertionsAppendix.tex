...
\begin{itemize}
\item
$\A \subseteqq \A'\  \IFF\    \forall \sigma_0,\sigma.\, \forall \M, \M'. \ [\ \ \M\mkpair \M', \sigma_0\ldots\sigma \models \A\ \mbox{ implies }\ \M\mkpair \M', \sigma \models \A'\ \ ].$
\item
...
\begin{enumerate}
\item
$\M\mkpair \M', \sigma \models \A$\ or\ $\M\mkpair \M', \sigma_0\ldots\sigma \models \neg\A$
\item
$\M\mkpair \M', \sigma_0\ldots\sigma  \models \A \wedge \A'$ \SP if and only if \SP $\M\mkpair \M', \sigma \models \A$ and $\M\mkpair \M', \sigma_0\ldots\sigma  \models \A'$
\item
$\M\mkpair \M', \sigma_0\ldots\sigma  \models \A \vee \A'$ \SP if and only if \SP $\M\mkpair \M', \sigma  \models \A$ or  $\sigma \models \A'$
\item
$\M\mkpair \M', \sigma_0\ldots\sigma  \models \A \wedge \neg\A$ never holds.
\item
$\M\mkpair \M', \sigma_0\ldots\sigma  \models \A$ and  $\M\mkpair \M', \sigma_0\ldots\sigma  \models \A \rightarrow \A'$  implies
...
\strut \hspace{1.1cm} (*) \ \ \ either $\M\mkpair \M', \sigma_0\ldots\sigma  \models \A$
or $\M\mkpair \M', \sigma_0\ldots\sigma  \not\models \A$.\\
