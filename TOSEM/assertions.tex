...
\mrr{To evaluate the entire call, we define a new reduction operator $\leadsto^\text{call}$, which executes function calls in one step. It does this by skipping any intermediate reduction steps with the additional frames for the method calls and its child calls in the tail of the stack.
}
