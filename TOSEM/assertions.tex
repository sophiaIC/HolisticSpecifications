...
We address challenge (b) by defining constrained reduction, \sdf{$\lceil\leadsto\rceil$ defined below}, where we only take the top of the frame when considering future executions.
...
\begin{definition}[Constrained Reduction]  \label{def:reduction:constrained}
...
\end{itemize}
\end{definition}
\jm{Constrained reduction (defined in Definition \ref{def:reduction:constrained}) is a form of reduction
