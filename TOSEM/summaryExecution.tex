...
\sophia{{\em Arising}} configurations are  those that can be reached by two-module execution, starting from the given initial configuration to maintain temporal linearity.
...
\sout{ $\Arising  {\M\mkpair\M'} \ = \ \{ \ \sigma \ \mid \ \exists \sigma_0. \ [\  \Initial{\sigma_0} \  \ \wedge\ \  \M\mkpair\M', \sigma_0 \leadsto^* \sigma \ \ ] \ \ \} $}
 \item
 \jm{$\Arising  {\M\mkpair\M', \sigma_0} \ = \ \{ \ \sigma \ \mid \ \sigma_0 \leadsto^* \sigma \ \ \} $}
 \end{itemize}
