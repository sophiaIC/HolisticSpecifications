...
\sophia{{\em Arising}} configurations are  those that can be reached by two-module execution, \mrr[starting from the given initial configuration to maintain temporal linearity]{Was out of date}.
