...
Fields are private in the \mrr[sense of C++]{I don't think there's much of a difference btw. Java/C++/.. \lstinline{private}, is there? I know some langs use "object privacy" rather than class privacy, but not many? Picking out C++ seems like "compared to", like there's something to watch out for }: they can only be read or
...
\sophia{{\em Arising}} configurations are  those that can be reached by two-module execution, starting from any initial configuration.
