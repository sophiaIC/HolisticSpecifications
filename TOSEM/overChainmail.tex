...
shown in the left and right diagrams in Figure \ref{fig:BankAccountDiagrams}\mrr[, and take a reasonable initial configuration $\sigma_0$]{Added this, and added $\sigma_0\ldots$ to below assertions}.
