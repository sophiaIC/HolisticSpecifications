...
shown in the left and right diagrams in Figure \ref{fig:BankAccountDiagrams}\mrr[, with $\sigma_0$ as the initial configuration]{Added this, and further modified by Prof. Eisenbach, and added $\sigma_0\ldots$ to below assertions}. 
...
fields of the various objects (\ie the heap).  
  ...
  $\strut$ \hspace{1.1cm}  $...,\sigma_0\ldots\sigma_1 \ \models \ \prg{a}_2.\prg{myBank}=\prg{a}_3.\prg{myBank}$
  \\
 $\strut$ \hspace{1.1cm}  $...,\sigma_0\ldots\sigma_2 \ \models \ \prg{a}_2.\prg{myBank}=\prg{a}_3.\prg{myBank}$.
   
  \mrr[Note, the module pair $M_{BA1}\mkpair M'$ or $M_{BA2}\mkpair M'$ has been elided throughout this section as ``$...$'' to focus on the configurations and assertions.]{Shouldn't we just explicitly give the modules?}
  
  The term \prg{x}:\prg{ClassId} says that \prg{x} is an object of class \prg{ClassId}. For example\\
  $\strut$ \hspace{1.1cm}  $...,\sigma_0\ldots\sigma_1 \ \models \ \prg{a}_2.\prg{myBank} : \prg{Bank}$.
...
For example:\\
 $\strut$ \hspace{1.1cm}  $...,\sigma_0\ldots\sigma_1 \ \models \  \CanAccess{\prg{a}_2}{\prg{b}_1}$
\\
If  $\sigma_1$ 
were executing the method body corresponding to the call ${\prg{a}_2}$.\prg{deposit}\prg{(}${\prg{a}_3}$,\prg{360}\prg{)},  then
we would 
  have\\
 $\strut$ \hspace{1.1cm}  $...,\sigma_0\ldots\sigma_1 \ \models \  \CanAccess{\prg{a}_2}{\prg{a}_3}$, \\
 ...
 \sophia{Access} is not symmetric, nor transitive:\\
  $\strut$ \hspace{1.1cm}  $...,\sigma_0\ldots\sigma_1 \ \not\models \  \CanAccess{\prg{a}_3}{\prg{a}_2}$, \hspace{0.6cm}\\
  $\strut$ \hspace{1.1cm} 
  $...,\sigma_0\ldots\sigma_2 \ \models \  \CanAccess{\prg{a}_2}{\prg{b}_1} \wedge \CanAccess{\prg{b}_1}{\prg{nd}_{10}}$, \hspace{0.6cm}
 %   $\strut$ \hspace{1.1cm}  
 $...,\sigma_0\ldots\sigma_2 \ \not\models \  \CanAccess{\prg{a}_2}{\prg{nd}_{10}}$.
...
For example, \\
 $\strut$ \hspace{1.1cm}  $...,\sigma_0\ldots\sigma_3 \models \  \Calls {\x}{\prg{deposit}}  {\prg{a}_2} { {\prg{a}_3},\prg{360}}$.\\
...
if  object \prg{94}  is included in $\SF_1$ but not in  $\SF_2$, then we   have\\ 
 $\strut$ \hspace{1.1cm}  $..., \sigma_0\ldots\sigma_1 \ \models \ \Using{ (\exists \prg{o}.\,\CanAccess{\prg{o}}{\acc_4})}{\SF_1}$
\\ % $\strut$ \hspace{0.2cm}  
 ...
 The set \SF\ in the assertion $\Using{\A}{\SF}$  is therefore {\em not} the footprint of   $\A$;
  it is more like the \emph{fuel} \cite{stepindex}  given to establish that assertion. Note that  $..., \sigma_0\ldots\sigma \ \models \Using {\A} {\SF}$ does not imply  
  $..., \sigma_0\ldots\sigma \ \models \A$  nor does it imply $..., \sigma_0\ldots\sigma \ \models \Using {\A} {\SF\cup\SF'}$.
...
$\M_{BA2}\mkpair ..., \sigma_0\ldots\sigma_4 \ \models \  \acc_2.\bal=\prg{60}$,  and that
$\M_{BA2}\mkpair ..., \sigma_0\ldots\sigma_4 \ \models \  \acc_4.\bal\geq\prg{360}$,
then\\ 
 $\strut$ \hspace{1.1cm}  $\M_{BA2}\mkpair ..., \sigma_0\ldots\sigma_4 \ \models \ \Future{ {\acc_2.\bal}=\prg{420}}$.\\
...
The assertion $\External {\prg{x}}$ expresses that the object at {\prg{x}} does not belong to the module under consideration. 
  For example, \\
$\strut$ \hspace{1.1cm}  $\M_{AB2}\mkpair ..., \sigma_0\ldots\sigma_2 \ \models \ \External{\pu_{92}}$,
%$\strut$ 
\hspace{1cm}  $\M_{AB2}\mkpair ..., \sigma_0\ldots\sigma_2 \ \not\models \ \External{\acc_2}$, \\
$\strut$
 \hspace{1.1cm}  $\M_{AB2}\mkpair ..., \sigma_0\ldots\sigma_2 \ \not\models \ \External{\pb_{1}.\prg{ledger}}$\\
...
\vspace*{-1mm}
\noindent $\M_{BA2}\mkpair ..., \sigma_0\ldots\sigma_2 \ \models \ {\Calls {\_}   {\prg{deposit}} {\acc_2} {\acc_3,\prg{60}} } \longrightarrow {\Future{ \Changes {\acc_2.\bal}}}$.
