...
Modules contain the definitions of ghost fields and method bodies the latter of which is needed to judge the validity of temporal assertions such as $\Future {\_}$. We distinguish between internal and external modules. This %offers two advantages:
\sophia{has two uses:}
First, 
