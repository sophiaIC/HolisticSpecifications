...
This means that high values \textit{can} be exposed, and the behaviour of
...
\susan{It isn't obvious what 'this' refers to.}
\Chainmail\ differs from this work in a number of ways. 
This work is concerned primarily about mechanisms that ensure encapsulation aka
