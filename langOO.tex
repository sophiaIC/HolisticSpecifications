...
consist of field, method definitions and ghost field declarations.
 ...
 and method signatures consist of  sequences of parameters without types, and no return type.
...
\sd{Ghost fields are defined as implicit, sideeffect-free functions with zero or more parameters. They are ghost information, \ie 
...
Note that the expressions that consist the bodies of ghostfield declarations (\prg{e}) are more complex than the terms that 
appear in
