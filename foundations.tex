...
must hold ``in the open world'' --- that is, when our module may be
...
\se{where does the aux come from? I think what you said in the fragment calculus about disjointedness is neater}
...
\se{if you like this I will write macros so as not to have parameter lists with the keywords, alternatively this list could just have the identifiers and no descriptions }
...
\se{if you prefer this paragraph then link it back to section 4}
