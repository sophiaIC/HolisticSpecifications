...
We first define runtime configurations, $\sigma$ as tuples 
...
\begin{itemize}
\item 
An enumerable set of ddresses \prg{Addr}.
\item
Values, $v$, are either addresses or null: $v \in \{ \prg{null} \} \cup \prg{Addr}.
\item
Frames, $\phi$, are mapping from identifiers to values: $\phi \ \in\ \prg{Ident} \rightarrow Value$,
\item
