...
Chainmail supports several temporal operators familiar from temporl
...
to give expressivenes in writing assertions: this does not offer any
...
notificaiton, by replacing $\Future \A$ or $\Past \A$ with 
$\Next \A$ or $\Prev \A$.
