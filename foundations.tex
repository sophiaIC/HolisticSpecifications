...
$~ \strut  \hspace{1.3in} \M \models \A \ \ \  \ \ \ \mbox{             if               } \ \ \  \ \ \   \forall \sigma\in\Arising {\M \mkpair  {\M'}}. \ \M \mkpair  {\M'}, \sigma \models \A$.  \kjx{was $\M \mkpair  {\M''}, \sigma \models \A$}\\
In that sense, module {\M'}  represents all possible clients of {\M}; and as it is arbitrarily chosen, it reflects the open world nature of our specificati/ons.
...
\begin{definition}
Given runtime configurations $\sigma$,  $\sigma'$,  and modulepair $\M \mkpair \M'$ we define
\label{def:module_pair_execution} trough execution,  \kjx{``trough''?}
\begin{itemize}
\item
...
\begin{itemize}
\item
 $\M \mkpair \M', \sigma \leadsto \sigma'$  implies $\M \mkpair (\M'\link\M'') ,\sigma \leadsto \sigma'$. \kjx{was $\M'\link\M'$}
\item
