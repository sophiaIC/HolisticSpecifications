...
\item
\label{cProtected}
$\satisfiesA{M}{\sigma}{\protectedFrom{x} {z}}$  \ \ \ iff \ \ \   $\satisfiesA{M}{\sigma}{x \neq z}$  and \\
\strut \hspace{1.3in} $\forall f_1,...f_n.[\ \interpret{\sigma}{z.f_1...f_n}=\interpret{\sigma}{x} \ \Longrightarrow \exists k<n. 
[\,\satisfiesA{M}{\sigma}{\internal{z.f_1...f_k}} \, ] \ ]$
\item
...
We define when a specification $S$ is stronger than another specification $S'$  in the context of a  module:  \begin{itemize}
\item
...
\begin{lemma}
Consider assertions $A$, $A'$, and module $M$:
\begin{itemize}
\item
$\stronger M {\OneStateQ {\overline {x:C}}  {A}}  {\TwoStatesQ {\overline {x:C}} {A}{A}} $ 
\item
If $y$ free in $A$, then \ \  $\strongerEq  M  {\OneStateQ    {y:\prg{Object}}   {\forall \overline {x:C}[ A ] } } 
    {\OneStateQ {\overline {x:C}}  {A}} $.
\item
$M,  {\OneStateQ {\overline {x:C}}  {A}} 
  \models  {\OneStateQ    {y:\prg{Object}}   {\forall \overline {x:C}[ A ] } } $
\item
