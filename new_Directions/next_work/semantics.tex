...
\label{def:deep}
The relation  $\leadstoOrig  {M} {\sigma_1}   {\sigma_2}$ is defined  in appendix ... The relation $\leadstoOrigStar  {M} {\sigma_1}   {\sigma_2}$  is the reflexive, transitive closure of $\leadstoOrig  {M} {\sigma_1}   {\sigma_2}$ .
\end{definition}
}
...
Therefore, 
 ...
 but not  $\notLeadstoBoundedStar {M} {\sigma_8} {\sigma_8} {\sigma_{15}}$  
}
