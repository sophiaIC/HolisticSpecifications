...
\strut \hspace{1.3in}  \sd{for all  $o$ such that $\sigma \models \GRelevant o$, where $x$ is free in $\sigma$ } 
\item
\label{quant2}
$\satisfiesA{M}{\sigma}{\ex{x}{A}}$ \ \ \ iff \ \ \  
$\satisfiesA{M}{\sigma[x \mapsto o]}{x:C} \ \ \wedge \ \ \ \satisfiesA{M}{\sigma[x \mapsto o]}{A}$, \\
\strut \hspace{1.3in}  \sd{for some $o$ such that $\sigma \models \GRelevant o$, where $x$ is free in $\sigma$. }
\item
\label{cInternal}
...
\strut \hspace{1.3in}  
\sd{$\satisfiesA{M}{\sigma} {\external {z}}\ \wedge \ \sigma \models \LRelevant z\ \Longrightarrow\ 
...
\\
~ \strut \hspace{.2cm}  
$\satisfiesA{M}{\sigma_1}{\LRelevant{ \, \{\,1, 2, 3, 4, 5, 6\, \} \, }}$, \ \  \ \ $M, \sigma_1 \not\models {\LRelevant{ \,7\, }}$.\\
~ \strut  ~ \hspace{.2cm}  
$\satisfiesA{M}{\sigma_2}{\LRelevant{ \, \{\, 2, 3, 4\,  \} \, }}$, \ \  \ \ $M, \sigma_2 \not\models {\LRelevant{ \, \{\, 5, 6, 7\,  \} \, }}$. \\
...
% and\ \ $\sigma \models \Relevant {\overline o}$ \\
...
\end{definition} 
  ...
  \footnote{\sd{Note that in the second bullet we do not drop the requirement that $\arising{M_{ext}}{M}{\sigma}$}}% \ \wedge 
