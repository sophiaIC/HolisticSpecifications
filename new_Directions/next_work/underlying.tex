...
\begin{itemize}
\item
\sdN{$ \PushSF  {\phi} {\sigma} \ \triangleq \ (\phi\!\cdot\!\psi, \chi)$ \ \ \  if \ \ \  $\sigma=(\psi, \chi)$}
\item
$ \PushS  {\alpha} {\sigma} \ \triangleq\ \{ \ \sigma' \ \mid\ \exists \phi  \ s.t.\ \ 
\sdN{  \sigma'=\PushSF  {\phi} {\sigma}  \ \wedge\    Rng(\phi)=\overline \alpha \ \ }  \ \}$
\item
...
\begin{itemize}
\item
\sdN{$\EarlierS {\sigma}  {\sigma'} \ \ \triangleq \ \ % \exists  \psi, \psi', s.t. 
 \exists  \phi, \phi',\psi. [\  \sigma\!=\!(\phi\cdot\psi,\_)\, \wedge\, \sigma\!=\!(\phi'\cdot\psi,\_)\ ] \ \  \vee\  \ 
