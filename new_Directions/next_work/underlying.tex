...
\newcommand{\Pushes}[2] {\ensuremath{ #2  \pushSymbol (\overline{#1})}}
\newcommand{\Pop}[1] {\ensuremath{ #1 }\popSymbol}
...
\item
$\Pop{\sigma}$ is the  state which results out   out of popping the top frame on the stack of $\sigma$, and leaving heap unmodified. It corresponds to method return.
\item
