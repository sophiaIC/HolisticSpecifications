...
\sdred{In our examples, we use numbers and booleans -- these can be encoded.}
 ...
 The syntax of \LangOO is given in Fig. \ref{f:loo-syntax}. It  includes syntax for ghost terms \sue{and fields} %with  $\re$ 
 that may %only
be used in writing
specifications.
\forget{or the definition of ghost functions (ghost fields)} 
