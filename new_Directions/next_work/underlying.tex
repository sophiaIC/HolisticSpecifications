...
Thus, $\sigma_a\in   \PushS  {\alpha} {\sigma_b}$ means that $\sigma_a$ is the result of pushing a frame onto \sdN{$\sigma_b$'s stack}, and also that  $\sigma_b$ is the result of popping a frame from \sdN{$\sigma_a$'s stack}.
 % below 
