...
\sdred{In our examples, we use numbers and booleans -- these can be encoded.}
 ...
 The syntax of \LangOO is given in Fig. \ref{f:loo-syntax}. It  includes syntax for ghost terms $\re$ that may %only
be used in writing
specifications or the definition of ghost functions (ghost fields). 
...
\sdred{
In well-formed states, $\Mtwo \models \sigma$,    the value of any parameter in any all callee   (${\RestictTo  \sigma {k}}$) is also the %same as the 
