...
\susan{I don't think the two lines at the bottom of the figure are needed here and in the next figure} 
...
{To develop the semantics of our assertions language, \AssertLang, we   build three auxiliary concepts on  top of  \LangOO: bounded execution, \susan{RATHER THAN pushing frames, and locally  reachable objects. I matched the section headings} method calls and returns, and reachable objects.}
