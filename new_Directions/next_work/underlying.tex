...
\item
$\Pop{\sigma}  {\va} {\sigma'}$ holds when  $\sigma'$ is the  state which results out   out of popping the top frame on the stack of $\sigma$, and leaving heap unmodified -- $\sigma'$ is the next state after a method return $\sigma$.
\item
