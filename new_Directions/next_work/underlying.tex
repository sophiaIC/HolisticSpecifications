...
\section{\se{Crucial} Concepts}
\label{s:auxiliary}

{The semantics of our assertions language % , \AssertLang, 
is based on three  \se{crucial concepts built} on  top of  \LangOO: {method calls and returns, scoped execution}, and locally reachable objects.}
