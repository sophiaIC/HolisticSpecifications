 ...
 \newcommand{\pushSymbol}{\bigtriangledown} % {{\blacktriangledown}}
  \newcommand{\popSymbol}{\bigtriangleup} %{{\blacktriangle}}
% \newcommand{\Push}[4] {\ensuremath{  #4 \pushSymbol  (\overline{#1 \mapsto #2}, #3)}}
...
% \blacktriangle \delta \vartriangle
...
For all modules $M$, states $\sigma$, $\sigma'$, for all objects $o$, atoms ${\overline \va}:$\footnote{\sdN{TODO decide whether $o$ or $\alpha$}}
