...
They are characterized through pushing/popping stack frames. %, and thus restrict/extend the set of locally reachable objects. 
The operator   $ \PushS  {\phi} {\sigma}$ pushes 
frame $\phi$ onto the stack of $\sigma$.
% $\PushS  {\alpha} {\sigma}$ describes the effect of pushing a stack frame,
