...
Hoare logics can specify enabling or effects (through per-method PRE/POST-condition pairs), but cannot specify guarding of effects.
...
Our specifications should describe \sdN{which effects are guarded by which capabilities}. And \sdN{these hards should be valid
 in the context of taking emergent behaviour.}   
