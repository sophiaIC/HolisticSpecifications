...
the capability that allows withdrawal from $o_4$. We highlight this through a dark outline to $o_4$.
\end{minipage}
& \ \  \   &
...
&
$\sigma_1  \models \inside{o_5}$
&
$\sigma_2 \models \inside{o_5}$
&
$\sigma_3 \models \inside{o_5}$
%\\
...
\end{description}
 ...
 Fig. \ref{fig:illusrPreserve} illustrates these points: 
