...
\noindent 
The first task is to describe that effect  $E$ took place: if we  find  some assertion $A$ \sue{(\eg \sdred{ balance is $\geq$ some value $b$})}which is invalidated by $E$, then, (*) can be described by something like:
