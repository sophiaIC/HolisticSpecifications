...
How can we express the guarantee that effects are \tamed?  
 ...
 Traditional PRE/POST condition specifications cannot express guarantees that two or more of our methods won't interact to produce an untamed effect. 
...
%\\
$\strut \ \ \ \ \ \  \ \  \ \ \   \quadruple {A_1  \wedge  \inside{\prg{a.key}} \wedge  \prg{a.\balance}\!=\!{\prg{b}} } {\   stmt\_b  \  } {\inside{\prg{a.kay}} \wedge  \prg{a.\balance}\!=\!\prg{b}}   
