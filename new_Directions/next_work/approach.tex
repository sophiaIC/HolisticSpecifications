...
\sdN{For our work, we assume an underlying sound Hoare logic for  language, and extend it with rules about protection, external calls, and the module's adherence to its 
