...
\Eg to prove satisfaction of $S_1$ and $S_3$ for method \prg{Shop::buy} we  need to prove:
\\
% {\footnotesize{
...
% }}
\\
and similar for \se{$S_2$ and $S_4$}. Here we used   $stmt\_b$  as short for the method body of \prg{buy}, and $A_1 \triangleq \prg{this}:\prg{Shop}, \prg{buyer}:\prg{external}, \prg{anItem}:\prg{Item} \wedge \prg{a}:\prg{Account}$
