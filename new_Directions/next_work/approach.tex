...
\noindent
This example illustrates two crucial properties. Namely, our   invariants are 
...
\noindent
%{$\bullet$}
\emph{Scoped}:     They ensure that invariants are preserved during execution of a certain method, but \emph{not} after completion of that method.
...
% the  {called method}, we know that the effects of the call are limited according to the module's scoped invariants. 
