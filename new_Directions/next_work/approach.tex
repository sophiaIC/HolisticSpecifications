...
% SD: drop reachable, as we not define it here, and it is not that fundamenal, I think
% reachable 
\sdN{state} $\sigma$ 
...
% In other words, the call active in  $\sigma$  \emph{scopes} how much og the future is relevant. 
...
% f execution of its body in a state
