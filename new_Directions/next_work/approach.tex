...
so long they %are it 
hold \sdN{upon entry to external modules.}\footnote{Not quite true. How improve?} 
...
%\susan{it sounds like capabilities and emergent behaviour are different things, perhaps Specifications for Capabilities including Emergent behaviour - or
something similar. \sdN{Any better now?}}
...
\sdN{For our work, we assume an underlying sound Hoare logic for \susan{our} language, and extend it with rules about protection, external calls, and the module's adherence to its 
