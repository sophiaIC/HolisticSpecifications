...
\vspace{.1cm}
  ...
  \noindent
\sdN{\textbf{NOTES}
 \notesep We can  apply $S_4$ at the point of call in line 7, even though the pre-state in $S_4$ is expected to satisfy a \emph{stronger} property than we have.
 Namely,   $S_4$ requires that the password is protected, while we only know 
  that the password is protected from   \prg{buyer}.
 We may do that,  because from the point of view of the callee at line 7 the password is protected -- \cf Fig, 5,   Lemma 4.7, and the 
