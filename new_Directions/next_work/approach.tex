...
This gives rise to the two challenges:\  1$^{st}$:  A specification language which describes access to capabilities and limited effects,\ 
...
\end{description}
 ...
 Fig. \ref{fig:illusrPreserve} shows the  states of some, unspecified, execution,  {starting at internal state $\sigma_4$ and terminating at internal state $\sigma_{23}$.}
...
\noindent
This example illustrates {three} crucial properties of our   invariants. Namely, they are
