...
More worryingly, is it possible that the \prg{buyer} will use this opportunity  to drain the shop's account?
 ...
 \susan{ Up to now we only know about module-wide specifications. I think you need to introduce where the Hoare triple comes from in your specification language. Also the triangle operator needs more justification of why you need to change the viewpoint to verify the specification.}
