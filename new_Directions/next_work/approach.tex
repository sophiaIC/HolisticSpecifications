...
\sdN{Below we show a simplified version of the Hoare logic rule \ruleExtCallB\ from Fig.\ref{f:external:calls} }
 ...
 $\inferruleSD{\hspace{4.7cm} [\ruleExtCallB]}
 	{ 
...
A method preserves an assertion $A$ if it preserves it across its pre- and post-states and also during any intermediate external state.
...
To prove satisfaction of $S\_1$-$S\_4$ for method \prg{Shop::buy} we  need to prove:
\\
{\footnotesize{
