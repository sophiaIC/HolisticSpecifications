...
are numbers and booleans values that appear also in the oper semantics?
\item
...
\item
add oper semantics rules that avoid call across modules and same for field read or write
