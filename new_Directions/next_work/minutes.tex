...
\item
\label{prove_Shop}
Worked examples: Complete the proof of \prg{Shop} and show that $M_{bad}$ does not satisfy the spec.  
...
\item 
\st{Discuss why we do not have the counterpart of rule {\sc{Call\_Int}}  for external calls. } 
...
\section{19th December 2024 -- Next Version}
...
- Add diagrams for scoped invariants

- Make the diagrams related to Shop, rather than abstract

- Repeat that no addresses can be forged, and thus the Kay cannot be guessed

- Add the application of Hoare logic for the proof of the body of buy, in particular the call to “payMe”

- ?? Add the proof of “set” 

- Check that we give a def. for all technical terms we use such as “step”, “frame”, “path” — or not?
