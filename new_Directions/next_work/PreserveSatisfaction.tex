...
$\Pos{A}$ assertions are not necessarily preserved against pushing of external frames.%  with external callees. 
\Eg for  
   $\sigma_1$ and  $\sigma_2$     as in the middle and right pane of  Fig. \ref{fig:Protected}, then % :  We have
...
We will see how to do that in the next section, and also in Section \ref{s:scoped:valid}.
