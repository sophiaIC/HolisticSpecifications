...
Moreover, assertions which do  not contain $\inside {\_}$ in negative positions, called $\Pos {\_}$,  are stable against pushing  of {internal} frames -- 
% SD chopped the \Neg - definition
...
\item 
$\Pos{A}\ \ \ \  \Longrightarrow \ \  \ \  [\ \ M, \sigma \models A \  \wedge \  M, {\PushSLong \phi \sigma} \models  \intThis \ \ \Longrightarrow \ \  M,{\PushSLong \phi \sigma} \models A\ \ ]$
%\item 
...
Nevertheless, to work with method calls, it is  it is crucial to be able to ensure at the point of a method call, that upon method entry the method's precondition will hold, 
