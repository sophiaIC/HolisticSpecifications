...
(61b?) follows easily from  the fact that \prg{a.key} did not change, and  {\sc{Prot-1}}.

\vspace{.5cm}
We look at the proof of (61a?).  We will apply the {\sc{Cases}} rule, and distinguish on whether \prg{a.key}=\prg{this.key}. That is, we want to prove that\\
\small{
\begin{align*}
\text{(61aa?)}  \ \ \ \ M_{fine} \vdash 
...
\vspace{.2cm}
\normalsize
We can prove (61aa?) through application of {\sc{Absurd}}, {\sc{ProtNeq}}, and {\sc{Consequ}}, as follows
