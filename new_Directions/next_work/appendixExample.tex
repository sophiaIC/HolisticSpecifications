...
\subsubsection{Demonstrating that $M_{good} \vdash \STwoStrong$, and that $M_{fine} \vdash \STwoStrong$}
...
Using (21) and {\sc{[Prot-1]}},  and {\sc{[Embed-UL}}, and {\sc{[Types}},  and    {\sc{[Consequ}}, we obtain
