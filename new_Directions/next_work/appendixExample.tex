...
\sdred{We will also need to prove that \prg{Send} satisfies specifications $S_{2a}$ and $S_{2b}$.}
...
$M_{bad}$ does not satisfy $S_3$. We can argue this semantically (as in \S \ref{s:bad:not:S2}), and also in terms of the proof system (as in \ref{s:bad:not:S2:proof}).
