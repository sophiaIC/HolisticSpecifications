...
\red{Actually,  a better way to think about this is if we are proving that $M_{good} \vdash \STwoStrong \wedge S_4$ where $S_4$ is the specification of \prg{Shop::send}.}
