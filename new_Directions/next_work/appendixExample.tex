...
submitted as an artefact. %\red{xxxx}.
...
\subsection{Proving method \prg{set} from $M_{better}$}
...
By  {\sc{ProtNeq}}, we have $M_{better} \vdash  \protectedFrom {\prg{a.key}} {\prg{key'}} \, \longrightarrow\, {\prg{a.key}}\neq {\prg{key'}}$, and therefore obtain
