...
\sdnew{property  preservation within the current  and all nested calls}.
...
\sdnew{\Eg to prove  that  \prg{Shop::buy} satisfies {$S_4$}, taking   $stmts_{b}$ % $stmt\_{buy}$   is 
for the    body of \prg{buy},  we  have to prove:}
\\
...
\sdnew{proceeds using}   \sdnew{our Hoare quadruples logic}. % discussed in this section.
The treatment of external calls is of special interest. 
% For example,   % consider  the 
%  \sdnew{for the proof of  \textbf{(0)}}, %verification of $S_4$. 
\sdnew{Here,} the challenge is % how to reason  about 
