...
% rather than public/private annotations,
and languages that support ownership types \sdnew{\eg} Rust, %that can be
 leveraged for verification
\cite{leveragingRust-oopsla2019,RustHornBelt-pldi2022,verus-oopsla2023},
and 
% languages from the
% functional tradition such as OCAML, with % which are gaining imperative
\sdnew{features} such as ownership and uniqueness\cite{funk-ownership-oopsla2024,ocaml-ownership-icfp2024}. 
\sdnew{These} different language paradigms may lead to \sdnew{refined view of the meaning
of protection}. %, and faming operations.
\sdnew{We also want to consider a tighter integration with the undelying Hoare logic and with  its framing operators.}
