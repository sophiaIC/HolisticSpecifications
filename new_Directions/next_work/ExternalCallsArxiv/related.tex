...
%  \sdnew{these works} 
in that %\sdnew
{they follow a ``static'' capability model whereby authority is conferred though an object's interface, whereas we follow a ``dynamic'' model whereby authority may be stored in the callee's context.}
%
