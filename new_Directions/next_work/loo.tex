...
\infer
		{
		\eval{M}{\sigma}{gt}{\alpha}
		}
		{
		\eval{M}{\sigma}{gt.f}{\interpret{\sigma}{\alpha.f}}
		}
		\quad(\textsc{E-Field})
		\and
\infer
		{
		\eval{M}{\sigma}{gt_0}{\alpha}\\
		\overline {\eval{M}{\sigma}{gt}{v}}\\
		\prg{ghost}\ gf(\overline{x : T)}\{gt\} : T'\\! \in\! M(\class{\sigma}{\alpha})(\prg{gflds})\\
		\eval{M}{\sigma}{[\overline {v/x}]gt}{v}
		}
		{
		\eval{M}{\sigma}{gt_0.gf(\overline{gt})}{v}
		}
		\quad(\textsc{E-Ghost})
\end{mathpar}
}
