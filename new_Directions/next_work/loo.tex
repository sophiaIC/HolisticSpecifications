...
\item Follows from the definition of $\DepthSt {\_}$, and $\leadstoBoundedThree {\_} {\_} {\_} {\_}$
???????????????
...
\beginProof{l:var:unaffect} By  induction on the number of steps, and  using the earlier point. 
