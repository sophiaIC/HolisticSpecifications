...
$\Formals \sigma \Mtwo \ \ \triangleq \ \  \overline x \ \ \ \mbox{such that} \ \  \  \exists \overline {\phi}\,\phi_k, \phi_{k+1}.[   \ \ \sigma = ((\overline {\phi}\cdot{\phi_k}\cdot{\phi_{k+1}}\,, \chi) 
 \ \wedge$\\
$\strut \hspace{3cm}  \phi_k.\prg{cont}=\_:=y_0.m(\_); \_ \    \wedge\ \meth{\Mtwo} {\class{(\phi_{k+1},\chi)}  {\prg{this} } } {m} = p \ C::m(\overline{x : \_}){:\_}\{\_\} \ \}
$
\end{definition}
