...
The syntax of \LangOO is given in Fig. \ref{f:loo-syntax}\footnote{\se{Our motivating example is provided in a slightly richer syntax for greater readability.}}.
