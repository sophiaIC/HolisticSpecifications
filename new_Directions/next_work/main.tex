...
The Coq source code for the mechanised proofs
and an extended version of the paper
including extensive appendices of full definitions and manual proofs
have been uploaded as anonymised auxilliary information with this
submission.
...
\input{loo}
\clearpage
\input{appendixAuxiliary}
% No appendix needed
% Section has no lemmas
% \clearpage
%\input{appendixAssertions}
\clearpage
\input{appendixPreserve}
\clearpage
\input{appendixSpecifications}
\clearpage
...
%%\label{a:necSpec}
%%\input{appendix-necessityspecs}%%\clearpage
