...
For module invariants we prove that there are preserved for all public methods of the module.

\vspace{.1cm}
Before describing these two phases, we introduce some preliminaries.
