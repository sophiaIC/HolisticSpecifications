...
In the below, the push- and pop- relations on assertions have now become just one  function,   \sdN{namely\\
...
perhaps deceptively simple. \sdN{An I am surprised that we only need ONE operator $\pushSymbol$}
...
\vspace{.1cm}
{\red{
I am copying Lemma \ref{lemma:lifts} and \ref{lemma:lowers} here for easy comparison
