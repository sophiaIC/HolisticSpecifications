...
\TODO{\red{TODO: motivate better}}
\subsubsection{Stable assertions} are those which   do not contain the requirement $\inside{\_}$ are called {\emph {stable}}. 
Their satisfaction is stable against pushing and popping of frames.
...
%{{Rule   {\sc{consequ}} is more interesting, because it employs a new inference, {\red{$\inferd$}}, rather than  the usual inference, $\rightarrow$.
