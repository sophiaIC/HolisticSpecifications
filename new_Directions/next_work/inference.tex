...
\sdN{\textsc{Prot-2},\textsc{Prot-3} and \textsc{Prot-4} describe the preservation of relative protection.
...
Note that ``protection'' of an object can decrease is if we call an external method, and pass it % not only internal an internal object 
...
adapted version also holds after the call. 
% SHORTER
