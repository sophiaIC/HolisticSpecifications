...
\paragraphSD{Preliminaries:} Specification Lookup,  Renamings, Underlying Hoare Logic}
...
Polymorphic Calls} Our rules do  not directly address the possibility that we do not statically know whether the receiver is
 % might belong to one class or another class, or even
  internal or external, and   the choice is made at runtime. 
