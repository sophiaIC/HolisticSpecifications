...
\infer
	{ }
	{\hproves{M} 
						{A \wedge \external{x} \wedge \protectedFrom{y}{x}}
						{ \ x.m()\  }
...
\infer
	...
	\textit{methods exported from} D,\ \textit{and } \prg{mBody}(M,D,m)=\overline{y:D}\{ s \}\\\\
				 \strut \hspace{3cm}[\ \  \hproves{M}{\  \overline{x:C}\wedge A \prg{this}:\prg{D} \wedge\overline{y:D}\ } {\ \prg{mBody}\ } {\ A\ } \\\\
				 \strut \hspace{3cm}\ \ (\  s = s_1; z.m'(\overline{y}) \wedge \\\\
				 \strut \hspace{3cm}\ \ \ \  \hproves{M}{\  \overline{x:C}\ \wedge\  A \wedge\ \prg{this}:\prg{D} \wedge\overline{y:D}\ } {\ s\ } {\ A'\ } 
				 \ \wedge \
