...
\sdred{ As  discussed in \S  \ref{sec:howThird},   the $\pushSymbolInText$ allows us to adapt an assertion from the view of the callee to that of the caller,
 and is used in the Hoare logic from method calls. It is defined below.}
