...
In the outline of the Hoare proof of the external call in  \S  \ref{sec:howThird},  we saw that an assertion of the form $\protectedFrom \re {\overline {\re}}$ at the call site,  may imply $\inside{\re}$ at the call.
