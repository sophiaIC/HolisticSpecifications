...
\renewcommand{\sdN}[1]{\textcolor{amethyst}{#1}\xspace}
...
\title{Sermantics od Assertions and Speciafications}
...
A proposal for the semantics of assertions and specifications. In particular, how to deal with variables, and quantifiers.
\end{abstract}
