...
%TODO
%%$\satDAssertFrom M  \sigma k    {\PushASLong  {(\overline {v_1},\overline {v_6})} {(\Ain[\overline {v_6/v_2}] [\overline {\alpha_3/v_3}])}} $ \\ 
%%$\strut \hspace{2cm}  \hfill \Longrightarrow  \ \ \  \  
%%M, \sigma' \models  {\Ain[\overline { \alpha_3/v_3}][\overline { {\interpret \sigma {v_4}} / v_4} ] }$.
%%
%%
%\item
%\label{l:calls:callee:three}
%TODO
%%$\satDAssertFrom M  \sigma k   {(\Ain[\overline {v_6/v_2}] [\overline {\alpha_3/v_3}])  \wedge ( {\PushASLong  {(\overline {v_1},\overline {v_6})} {(\Ain[\overline {v_6/v_2}] [\overline {\alpha_3/v_3}])}})}   $
%% \\ 
%%$\strut \hspace{2cm}  \hfill \Longrightarrow  \ \ \  \   \satDAssertFrom M  {\sigma'} k  {\Ain[\overline { \alpha_3/v_3}]}$.
...
%\item
%\label{l:calls:callee:one}
%$\satDAssertFrom M  \sigma k   \Ao[\overline {v_3/v_1}] % [\overline {\alpha_2/v_2}] \ \   
%\ \ \wedge\ \ M, \sigma' \models \intThis  $
% \\ 
%$\strut \hspace{2cm}  \hfill \Longrightarrow  \ \ \  \   \ \satDAssertFrom M  {\sigma'} k  {\Ao[\overline { {\interpret {\sigma} {v_6}} / {v_6} } ] }$
%
%
%%\item
%%\label{l:calls:callee:two}
...
%TODO
%%$M, \sigma \models  {\Aout[\overline {\alpha_3/v_3}]}\ \ \wedge\ \  \overline {\interpret {\sigma'} {v_5}} \subseteq \LRelevantO \sigma
%%$ \\ 
%%$\strut \hspace{2cm}  \hfill \Longrightarrow  \ \ \  \  M , \sigma' \models  {\PushASLong  {\overline {v_5}}    {(\Aout[\overline {v_6 / v_2}][\overline { \alpha_3/v_3}])} }$
%
%
%\item
