...
$\satDAssertFrom M  \sigma k   \Ain[\overline {v_3/v_1}][\overline { {\interpret \sigma {v_3} }/v_3 }] $   
      \ \ \ \ \ By Lemma \ref{l:sfs:eight} and assumption \ref{l:calls:r:four} of the lemma, we obtain \\
 $\Ain[\overline {v_3/v_1}][\overline { {\interpret \sigma {v_3} }/v_3 }] \txteq \Ain[\overline  {\interpret {\sigma'} {v_1}/v_1}][\overline { \alpha_{6,1}/v_{6,1}}] $\\
%$\satDAssertFrom M  \sigma k   \Ain[\overline {\alpha_{1,3}/v_1}]  [\overline { \alpha_{6,1}/v_{6,1}}] $ \\ 
$\strut \hspace{2cm}  
      $ where   $\overline{v_{6,1}} \triangleq \overline{v_2} \cap \overline{v_3}$, \ \ 
   $\overline {\alpha_{6,1}} \triangleq  \overline {v_{6,1}} [\overline {\interpret {\sigma} {v_6}/v_6 }]$ \\
$\strut \hspace{2cm}  $ The above gives that\\
$\satDAssertFrom M  \sigma k   \Ain[\overline  {\interpret {\sigma'} {v_1} /v_1}  [\overline { \alpha_{6,1}/v_{6,1}}] $ \\    
$\strut \hspace{2cm}  $ The above, and   Lemma \ref{l:assrt:unaffect} part \ref{l:assrt:unaffect:one}  give that\\
$\satDAssertFrom M  \sigma k   \Ain[\overline  {\interpret {\sigma'} {v_1}/v_1}]  [\overline { \alpha_{6,1}/v_{6,1}}]  [\overline { \alpha_{6,2}/v_{6,2}}]$ \\ 
$\strut \hspace{2cm}  
