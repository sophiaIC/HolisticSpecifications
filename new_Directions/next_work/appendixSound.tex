...
and using Lemma \sdN{\ref{l:adapt:stable} and \ref{l:shallow:deep} part \ref{fiveSD}}, and \sdN{because $\overline z \cap \overline = emptyset$} we obtain \\
$\SPS (\alpha') \ \  \satDAssertFrom M  {\sigma'}  {\sdN{k}}  {\sdN {\PushAS y {A_{post}[y_0/ \prg{this},u/res]}[\overline{\alpha/z}}}$
\\

 \vspace{.1cm}
Proving $(\beta)$. Similar.
%The proof is similar to that of {\sc{Call\_Int}}, with the difference that 
