...
Lemma \ref{l:push:pop} is  about preservation of assertions when pushing or popping frames.
...
\item
\label{pp:l:one}
$\satDAssertFrom M  \sigma k   A  \ \ \wedge\ \  \sigma'=\sigma  \pushSymbol \phi\ \ \wedge\ \ M, \sigma' \models \intThis   \ \ \ \Longrightarrow \ \ \ \satDAssertFrom M  {\sigma'} k   A $.
...
\ \ \wedge \ \ 
\forall \alpha'[\ \LRelevant {\alpha'} {\sigma} \ \Rightarrow \  \LRelevant {\alpha'} {\sigma'}]\ \ \wedge \ \ $ \\ 
$\ M, \sigma' \models \intThis $ \\
$\strut \hspace{2cm} \Longrightarrow \ \ \ \  \satDAssertFrom M  {\sigma'} k   A  $.
...
% NOTE this requirement was not needed
...
$\LRelevant {\alpha} {\sigma} \ \ \wedge \ \ 
\forall \alpha'[\ \LRelevant {\alpha'} {\sigma} \ \Rightarrow \  \LRelevant {\alpha'} {\sigma'}]  
\ \wedge \ \ $ \\ 
$\ M, \sigma' \models \intThis \ \ \wedge {\overline {\alpha}} \subseteq dom (\phi_n)$ \\
...
% NOTE this requirement was not needed
%  \wedge\ \ M, \sigma' \models \intThis
   \ \ \ \Longrightarrow \ \ \ \satDAssertFrom M  {\sigma'} k   {A \wedge( \PushAS   {\alpha} {A})}  $.

\item
 \label{pp:l:six}
$\satDAssertFrom M  \sigma k     {A \wedge ( \PushAS   {\alpha} {A})} \ \ \wedge\ \  \sigma = ((\overline {\phi}\cdot \phi_n \cdot \phi_{n+1}),\chi)\ \ \wedge$\\
$ \sigma' = ((\overline {\phi}\cdot \phi_n[x\mapsto \alpha][\prg{cont}\mapsto stmt],\chi) \ \  \wedge \ \ k \leq \DepthSt {\sigma'}$ \\
$\LRelevant {\alpha} {\sigma} \ \ \wedge \ \ 
\forall \alpha'[\ \LRelevant {\alpha'} {\sigma} \ \Rightarrow \  \LRelevant {\alpha'} {\sigma'}]  
\ \wedge \ \ $ \\ 
$\ M, \sigma' \models \intThis \ \ \wedge {\overline {\alpha}} \subseteq dom (\phi_n)$ \\
$\strut \hspace{2cm} \Longrightarrow \  \satDAssertFrom M  {\sigma'} k   {A \wedge( \PushAS   {\alpha} {A})}  $.
