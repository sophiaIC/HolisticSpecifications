...
Since we are now executing a public method, and because $\vdash M$, we can apply {\sc{Method}}, and theorem \ref{t:quadruple:sound}, and obtain $ \satDAssertFrom M  {\sigma'} k A$\\
 \vspace{.1cm}
  {\textbf{End Proof Sketch}} 
