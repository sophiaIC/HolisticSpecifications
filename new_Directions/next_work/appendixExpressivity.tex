...
\red{TODO:  explain. the above}
Note that $S_{dom\_2}$ is strictly stronger than $S_{dom\_1}$ \footnote{\red{We have not defined strictly stronger in this document}.}
...
Namely, Solidity supports a special construct, called \red{\prg{toFindOut}} which indicates the identity of the caller.
...
\prg{ERC20Spec1} is related to $S_{erc\_2}$. Note that \prg{ERC20Spec1} is more API-specific, as it expresses the precise methods which caused the nodificatiation of the balance.
