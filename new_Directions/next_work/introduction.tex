...
controlling capabilities.\forget{that reify those
...
%``Operating System:\ldots there shouldn't be one'' \cite{ingalls1981}.}. } 
 As argued by \citet{capeFTfJP}, %Drossopoulou and Noble have put it:
%\textit{``
 object capabilities
...
(2) a specification language to define how capabilities should limit effects, %effects should be limited by capabilities.
