...
\newenvironment{customquote}
  {\vspace{-0.5em} % Reduce vertical space before
   \begin{list}{}%
...
Capabiities are {\emph{necessary}} conditions for causing effects; callers can only produce effects if they possess the required capabilities. 
