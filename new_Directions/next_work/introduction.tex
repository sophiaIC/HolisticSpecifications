...
The code sketch below illustrates the point:  An internal, trusted module $M_{intl}$  has methods \prg{m1} and \prg{m2}.
Parameter  \prg{untrs}% in \prg{m2} 
 is an external object. 
The open call on line  6 is the challenge:
What effects can it have?
What happens if that call later on calls back into $M_{intl}$, \eg  calls  \prg{m1}?
\footnote{AUTHORS: Can we make the text wrap the code?}
%  \footnote{AUTHORS: I think we should not worry about public/private yet}
