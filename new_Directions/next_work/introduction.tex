...
\paragraph{The Object Capabiltiy Model}\footnote{SD says: check whether these two paragraph caliry the "necessary" nature}
...
As described by Mark Miller \cite{MillerPhD}, the
