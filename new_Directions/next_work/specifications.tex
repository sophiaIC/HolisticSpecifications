...
\subsection{\textbf{Syntax, Semantics, Examples}} Our specification language   supports scoped invariants,   method specifications, and {conjunctions}. 
...
In Def. \ref{f:holistic-wff}  later on we describe  well-formedness of $S$, but  we first show  semantics and some examples.
