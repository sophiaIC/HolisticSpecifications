...
\sdN{Specification is \emph{well-formed},  $\vdash S$,  is   defined by cases on $S$: \ \  \
...
{\sprepost
		{\strut \ \ \ \ \ \ \ \ \ S_9} 
		{ %a:\prg{Account}\wedge
		 \protectedFrom{\prg{this}.\prg{myAccnt}.\prg{pwd}} {\prg{buyer}} \wedge \prg{this}.\prg{myAccnt}.\prg{\balance}=b
		 }
		{\prg{Shop}} {\prg{buy}} {\prg{buyer}:\prg{external}, \prg{anItem}:\prg{Item} }
		{ 
		  \protectedFrom{\prg{this}.\prg{myAccnt}.\prg{pwd}} {\prg{buyer}} \wedge \prg{this}.\prg{myAccnt}.\prg{\balance}\geq b
		 }
}
%\\
%{\sprepost
...
\noindent
\sdN{Interestingly, entailment can deduce some method specifications out of two-state invariants.}
