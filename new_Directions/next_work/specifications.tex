...
\sdred{\begin{example}
${\satAssertQuadruple  \Mtwo  M     {A_1} {\sigma_{4}} {A_2} {A_3} }$  with $\sigma_4$ from Fig. \ref{fig:illusrPreserve}, % from  \S \ref{sect:approach:scoped}, -- short
assuming $\sigma_{23}$ has empty continuation, \     % ${\satAssertQuadruple  \Mtwo  M     {A_1} {\sigma_{4}} {A_2} {A_3} }$ 
says that if $\sigma_4$ satisfies $A_1$, then $\sigma_{23}$ will satisfy $A_2$, and $\sigma_6$-$\sigma_9$, $\sigma_{13}-\sigma_{17}$, $\sigma_{20}-\sigma_{21}$ will satisfy $A_3$.
 \end{example}}
