...
%e.g\  hold during a method, but not aFter the
%return value is popped off the top frame.
...
turn may may make external calls, etc\ldots% leading to further calls of public methods.
%
