...
\begin{enumerate}
\item
\sdN{$\satisfiesD{M}{\TwoStatesN {\overline {x:C}} {A}} \ \  \ \triangleq   \ \ \ \forall   \Mtwo. \forall  \sigma.
%$    \\ $\strut   \ \ \ \  \  \ \ \ \ 
 [ \ \   \arising{\sigma}{M\madd \Mtwo }\   \Longrightarrow \  {\satAssertQuadrupleFrom \Mtwo  M  \sigma   {\externalexec \wedge A} {A} {A} }\ \ ]$
}
  \item
 \sdN{$\satisfiesD{M} { \mprepostN {A}{p\ C}{m}{x}{C}{A'} {A''} }\  \ \ \   \triangleq  \ \ \ \forall    \Mtwo. \forall  \sigma$.    \\
