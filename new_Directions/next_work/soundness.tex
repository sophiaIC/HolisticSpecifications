...
{finally} prove soundness of the overall system  (Sect \ref{sect:prove:triples:overall}). 
...
In general, deep satisfaction is stronger than shallow satisfaction.
...
We assume a judgments, with the    form $M \vdash A$  which has the property that
\begin{center}
...
%REPLACED by side-by-side below
%\begin{figure}[htb]
%\begin{tabular}{c}
%\hline \\
