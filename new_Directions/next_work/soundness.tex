...
\noindent
Assume that \\  
$\strut \ \ (1) \ \ M\ \vdash\  \{\, A \,  \}\ stmt\  \{\, A' \, \}\ \ $ is proven in $P$,\\
$\strut \ \ (2) \ \ \vdash M $ is proven in $P$,\\
%We want to show that $M\ \models\  \{\, A \,  \}\ stmt\  \{\, A' \, \}$. 
$\strut \ \ (3) \ \ \sigma.cont = stmt$, \\ 
$\strut \ \ (4) \ \ M, \sigma \models A$, \\
$\strut \ \ (5) \ \ \leadstoBoundedStarFin {\Mtwo\cdot M}  {\sigma}  {\sigma'}$,\\
We want to show that\\
$\strut \ \ (\alpha)\ \  M, \sigma' \models A'$.

\vspace{.1cm}
\noindent
We proceed by case analysis on the last step in $P$'s proof of (1).
...
Therefore, $A \txteq A_1 \wedge A_2$,  and $A' \txteq A_1' \wedge A_2'$, and the direct predecessors of the proof of $(1)$
% in $P$ 
are $M\ \vdash\  \{\, A_1 \,  \}\ stmt\  \{\, A_1' \, \}$ and $M\ \vdash\  \{\, A_2 \,  \}\ stmt\  \{\, A_2' \, \}$. 
...
the proof of  $(1)$ %$M\ \vdash\  \{\, A \,  \}\ s_1;s_2\  \{\, A' \, \}$ in $P$ 
...
\item[${\sc{consequ}}$] Similar to the proof of \item[${\sc{combine}}$] 
...
Therefore, there exist $u$, $y_o$, $C$, $\overline y$,  $A_1$ and $A_2$ such that (6)\ $stmt\txteq u=y_o.m(\overline y)$, and (7)\ $A \txteq y_0:C  \ \wedge\ \overline {y:C}\ \wedge \ A_1$, 
and (8)\ $\promises M {\mprepost{A_1}{C}{m}{y}{C}{A_2} }$ and  (9)\ $A' \txteq  A_2[ u/result]$. 

By definition of $\vdash M$ in Section \ref{sect:wf}, we obtain that   $\prg{mBody}(m,C,M)=\overline{y:C}\{\  s \ \}$ and that
(10)  there exists in $P$ a proof of   ${\hproves{M} { \ \prg{this}:\prg{C}\, \wedge\, \overline{y:C}\, \wedge\, A_1\  } {\ s\ } {\ A_2\ } }$.
 
 By the operational semantics, we obtain that there exist states $\sigma_1$, and $\sigma_2$, such that 
 % $M\cdot \Mtwo, \sigma \rightarrow \sigma_1$, and 
 (11)\ $\sigma_1=\sigma ...[\prg{cont}\mapsto s]... $, TODO, and  (12)\ $\leadstoBounded  {\Mtwo\cdot M}  {\sigma}  {\sigma_1}$, and
 (13)\ $\leadstoBoundedStarFin {\Mtwo\cdot M}  {\sigma_1}  {\sigma_2}$, and 
 (14)\ $\sigma'=\sigma_2[...]$ TODO.
 
 From (10) and (11) we obtain that $( \prg{this}:\prg{C}\, \wedge\, \overline{y:C}\, \wedge\, A_1,\sigma_1,A_2) \ll_{M,\Mtwo,P} (A,\sigma,A')$. By induction hypothesis and (13) we obtain that (15) $M,\sigma_2 \models A_2$.
 
 By (14) and (15) we obtain that $M,\sigma' \models A_2[ u/result]$. 
%
