...
For this, we give a stronger, deeper meaning to the satisfaction of specifications, namely, ... TODO motivate ... In section  \ref{s:deep:mean} we define deep satisfcation of assertions.
...
\subsection{Deep satisfaction of assertions -- \red{better term than deep?}}  
\label{s:deep:mean}
\sdN{
...
\item
$fv(A)=\emptyset\ \wedge \ k\leq k'\  \wedge\ \satDAssertFrom M  \sigma {k}  A \ \   \Longrightarrow \ \ \satDAssertFrom M  \sigma {k'} A$ 
\end{enumerate}
\end{lemma}
}

 
 \red{TODO: define $\externalexec$. QUESTION delete the globally reachable story?  NOTE I deleted  Arising }
 
 
\subsection{Deep satisfaction of specification -- \red{better term than deep?}}  
\label{sect:HLmeans}
...
\forall \sigma.[\  \satisfiesD {M} {\quadruple {\externalexec \wedge A} {\sigma} {A} {A} } \ ] $
  ...
  \item
 \sdN{$\satisfiesD{M} { \mprepostN {A_1}{p\ C}{m}{y}{C}{A_2} {A_3'}    }\  \ \ \   \triangleq  \ \ \ $}\\ 
 \sdN{
$\strut  \ \ \   \ \ \ \ \ \ \ \ \   \ \ \     \forall   y_0., \sigma[ \ \  \sigma= {u:=y_0.m(y_1,..y_n)} \ \Longrightarrow \ \ \satisfiesD {M} {\quadruple  {\ y_0:C,{\overline {y:C}}   \wedge  A_1'\ }   
  {\sigma}  
    {A_2' }
     {A_3' }
  \  \  ]$ \\
$\strut  \ \ \  \mbox{where} \ A_1' \triangleq A[y_0/\prg{this}],\  \  A_2' \triangleq A'[u/res,y_0/\prg{this}],\ \ A_3' \triangleq A_3[y_0/\prg{this}]} $
  }
 \item
...
\begin{lemma}[Deep   vs Shallow Semantics of Specificarions]
...
\begin{center}
$M\ \vdash\  \triple A {stmt} {A'}$ \ \ \ \ $\Longrightarrow$ \ \ \ \ ${\satAssertQuadruple  \Mtwo  M    {\  A\ }  \sigma{stmt}  { A'  } {A''} } $
\end{center}
\end{Theorem}
...
\red{And that $A$ and $A'$ do noit contain proeced,} And Lemma \ref{l:shallow:deep}, part \ref{shallow:to:deep}. Moreover, 
