...
Nevertheless, we want to be able to deduce that an assertion which holds at the end of a method body, also holds upon return. For this, we introduce a notion of satisfaction from the view of several frames: % \emph{\strong satisfaction}: % of assertions: 
