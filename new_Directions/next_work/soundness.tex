...
\noindent
{\sdN{The proof of \ref{l:shallow:deep}.\ref{four} is by contradiction: Find a $\sigma$, a $k$ and   such that  
...
$\exists j\geq k.[M,{\RestictTo {\sigma}{j}} \not\models A'[[\overline{ {{\interpret \sigma z}/ z}}]$
 ...
 {\red{SD  wondered whether  \ref{l:shallow:deep}.\ref{four} would still hold if we allowed the assertions to "reflect" on the frame, to say things eg like "this and x are the only local variables". But such assertions would not have the property \ref{l:shallow:deep}.\ref{five}}}
