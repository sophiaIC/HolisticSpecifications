...
The diagram opposite shows such an execution:
  ...
  \textbf{four} external calls, %4 calls to external objects,
and  \textbf{three} internal calls. % 3 calls to internal objects.
...
%\begin{itemize}
%\item
$\WithExtPub {\Mtwo\cdot M} {\sigma\bd}  {\sigma}  {\sigma'} {\sigma_1...\sigma_n}$  \ \ says that $\sigma$ reaches $\sigma'$ through 
external states, interleaved with summarised public internal method calls, starting at ${\sigma_1...\sigma_n}$, respectively.
% end{itemize}
% \noindent
In our example, we have that \ \ \ $\WithExtPub {\Mtwo\cdot M} {\sigma_2}  {\sigma_{2}}   {\sigma_{20}}  {\sigma_5,\sigma_{21}}$.
