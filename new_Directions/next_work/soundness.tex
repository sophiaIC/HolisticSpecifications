...
We are faced with the problem that assertions are not necessarily preserved by  popping the top frame (\cf Ex. \ref{ex:pop:does:not:preserve}), %  and   \ref{ex:motivate:scopes}), 
