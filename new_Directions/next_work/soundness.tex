...
\item
 ...
 where $m$ is the minimal number so that $\exists \sigma'.[\ \leadstoBoundedStarFin {M\cdot \Mtwo} {\sigma}    {\sigma'}\ ]$ in $n$ execution steps, and where $n$ is minimal depth of all proofs of $M \vdash \{ A \} \sigma.\prg{cont}  \{ A' \} $ in $P$,
\item
