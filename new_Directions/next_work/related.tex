...
Incorporate with Separation Logic's powerful framing mechanisms  will pose several challenges: 
We have no specification and no footprint for external calls, that protection 
...
And we may require a  new separating conjunction.
