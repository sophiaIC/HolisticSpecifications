...
\citet{CassezFQ24} illustrates one approach to ensuring defensive
...
while we focus more on specifications% of programs' behaviour,
and proofs.% that programs can meet those specifiations.
...
%%%should mention michale jackson's wthesis
