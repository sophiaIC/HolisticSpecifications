...
A {summary} of this proof has already been discussed in \S \ref{s:approach}.
 A more complex variant of this example can be found in the 
 \jm[]{appendices %of the full paper 
 \cite{necessityFull}.} %Appendix \ref{app:examples}.
 ...
 several fields.} \julian{Mechanised versions of the proofs in both this Section, and 
...
We use \sdNr[used to say "a conservative approach to an encapsulation system" but "conservative" here means sound]{a simple encapsulation system}, 
\jm[]{detailed in the %full paper with 
appendices \cite{necessityFull}, }
