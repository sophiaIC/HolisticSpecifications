...
\item 
$\Pos{A}\ \ \   \wedge \ \ \   \forall \alpha. [ \ \alpha \in Rng(\phi) \ \Rightarrow \ \LRelevant \alpha \sigma \ ] \ \ \ \ \Longrightarrow $
\\
...
$ fv(A)=\emptyset$, we know that $\interpret {\sigma} {\re}$=$\interpret {\PushSLong \phi \sigma}  {\re}$. Therefore, we assume that 
 ...
 Because  $\forall \alpha. [ \ \alpha \in Rng(\phi) \ \Rightarrow \ \LRelevant \alpha \sigma \ ]$, we also obtain that
  $\forall \alpha. [ \  \LRelevant \alpha  {\PushSLong \phi \sigma}\ \Rightarrow\ \  \LRelevant \alpha  {\sigma}\ ]$.
