...
\noindent
\textbf{More on Def. \ref{d:encaps:semantic}} {If the definition \ref{d:encaps:semantic} used the more general execution, $\leadstoOrig  {M\madd\Mtwo}  {\sigma}{\sigma'}$, rather than the scoped execution,  $\leadstoBounded {M\madd\Mtwo}  {\sigma}{\sigma'}$, then fewer assertions would have been encapsulated.}
