...
%
%
To reason about internal code, programmers must reason about 
...
%%%kjx:
%%%by ensuring external objects can never gain access to the capabilities requird to invoke unwanted effects.
%%%kjx2
limiting potential effects by limiting access to the capabilities necessary to cause those effects.
%
