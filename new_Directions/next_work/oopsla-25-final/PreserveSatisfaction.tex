...
\subsubsection{{Stability}} %{Stability: Preservation across method call and return}
...
\subsubsection{{Encapsulation}} % : Preservation across heap modifications}
...
Judgment $M\ \vdash \encaps{A}$,  
{defined in} %Def 
\aref{D.4}{\ref{d:encaps:sytactic}},  
