...
%%% by Julian Mackay, Sophia Drossopoulou, James Noble, and Susan Eisenbach.
%%%
\setcopyright{cc}
\setcctype{by}
\acmDOI{10.1145/3763064}
\acmYear{2025}
\acmJournal{PACMPL}
\acmVolume{9}
\acmNumber{OOPSLA2}
...
\acmMonth{10}
\received{2024-10-16}
\received[accepted]{2025-08-12}\acmDOI{} % \acmDOI{10.1145/nnnnnnn.nnnnnnn}
\startPage{1}
...
\newcommand{\aref}[2]{#1 in \cite{externalCallsFull}}
...
\affiliation{
  ...
  \institution{Kry10 Ltd}           %% \institution is required
...
\email{julian@kry10.com}           %% \orcid is optional
\affiliation{
  %\position{Position2a}
  %\department{Engineering and Computer Science}             %% \department is recommended
  \institution{Victoria University}           %% \institution is required
  %\streetaddress{Street2a Address2a}
% \city{Wellington}
  %\state{State2a}
  %\postcode{Post-Code2a}
...
\affiliation{
  ...
  \institution{Imperial College}            %% \institution is required
...
%% Keywords
\keywords{Object Capabiliities, Untrusted Code, Program Verification.}  %% \keywords are mandatory in final camera-r
