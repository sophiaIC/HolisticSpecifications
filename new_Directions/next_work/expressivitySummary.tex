...
\paragraphSDD{Stack} is module exporting separate functions to read or modify its contents  expressed in Iris\cite{irisWasm23}. We specify that in the absence of external access to that capability, the contents will not change. 