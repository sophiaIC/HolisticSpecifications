...
% untrusted code
%By definition, 
Internal code does not trust external code.
Nevertheless, it has to call external code, and therefore needs to reason about the potential effects of such external calls.
...
that uses encapsulation and object capabilities to limit effects.
