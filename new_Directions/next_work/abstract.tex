...
%
%  external calls will preserve some \se{why only some?} assertions.
%
%% \se{Given that this is the abstract I would skip the next two
%%   sentences.}
%% \kjx{skipped}
...
which uses encapsulation and objects capabilities to \tame effects.
%\se{Are they assertions and specifications or assertion constructs
