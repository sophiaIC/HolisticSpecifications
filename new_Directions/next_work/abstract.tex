...
Nevertheless, it calls external code, and therefore needs to reason about the potential effects of such external calls.
...
\ie to ensure certain effects only happen if the external objects have access to the corresponding capabilities. 
%
...
using encapsulation and object capabilities to limit effects.
We propose new assertions for access to capabilities,
new specifications for limited effects,
