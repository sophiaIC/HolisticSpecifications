...
Capabilities \emph{guard} effects: callers can make the effect   happen, only is they have access to the corresponding capability.
...
To define the   management of sharing of capabilities, we propose the concept of  \sdN{protected capability} which guarantees  that access by externalobjects
...
\sdN{We  propose an extension of a Hoare logic that can prove that calls to external code are safe, and that modules satisfy our specifications.
