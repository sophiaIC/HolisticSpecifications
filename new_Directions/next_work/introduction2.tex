...
% external code 
and may even have been written by an attacker trying to subvert or destroy the whole system.  
...
The code sketch to the right  illustrates the problem.  A The challenge arises from the external call on line 6: 
...
programmers    rely on various kinds of  encapsulation -- \eg forging were possible, the range of potential effects from external calls would be limitless.
