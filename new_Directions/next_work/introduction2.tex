...
{If the programming language supports encapsulation (\eg private
 ...
 calls  {have limited effects}  on internal components.} %  can cause effects only if some conditions specific to that effect are met.
...
\sdN{\Taming of effects may be \emph{unconditional} of \emph{conditional}.
...
the l range of potential effects of external calls would be unlimited. 
