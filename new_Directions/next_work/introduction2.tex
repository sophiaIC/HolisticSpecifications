...
\sdN{To} reason about the effects of specific external calls, the systems mentioned above \sdN{would} rely on problem-specific, custom-made proofs rather than a Hoare logic.
