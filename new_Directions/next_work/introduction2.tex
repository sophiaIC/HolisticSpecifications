...
\forget{,  but require proofs specific to each individual problem, rather than a systematic Hoare logic.}
 Similarly,
\sdN{\citet{vmsl-pldi2023} propose a separation logic to support formal modular reasoning about communicating VMs, inlcuding in the presence of unknown VMs.
