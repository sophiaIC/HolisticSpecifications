...
% We  use the term \emph{\tamed  effects} for  effects which {may be caused by an external object, but only under certain conditions specific to that effect
...
% {For example, an external object may reduce the balance of the DAO, only if it has access
...
{1) a specification language to describe \taming of effects,
...
\susan{and Sect. \ref{s:preserve} discusses preservation of satisfaction of assertions.}
