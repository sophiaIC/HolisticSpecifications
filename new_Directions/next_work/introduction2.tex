...
\se{\paragraph{This paper's \sdN{contributions}} % In this paper we propose 
\sdN{1) a specification language to describe \taming of effects,
with new assertions to describe access to capabilities, 
2) a Hoare logic for reasoning about external calls and proving that modules satisfy \tamed effects specifications,
