\section{Another attempt at Introduction}
\label{s:intro}
...
Moreover, as execution of that open call may call back into the internal code, it seems as if the possible effects of the open call are unlimited.
...
\paragraph{\Tamed effects} Nevertheless, open calls do not always have unlimited effects.  
...
% %
 ...
 Often  programmers  \tame  effects in their code by  following the object capability model (OCAP)\cite{Miller}, where  
