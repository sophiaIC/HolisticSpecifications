...
With tamed effects, we can ensure that \susan{specified} properties established before an outgoing external call will be satisfied afterward.
...
The systems mentioned above that can reason about the effects of specific external calls, rely on problem-specific, custom-made proofs rather than a Hoare logic.
