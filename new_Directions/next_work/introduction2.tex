...
the Hoare logic. 
\susan{Sect.\ \ref{sect:example:proof:short} summarises  the proof of  our running example with its Coq proofs at \red{XXXX}}. 
%Sect.\ \ref{sect:related} discusses related
%work and
 Sect.\ \ref{sect:conclusion} concludes with related work. 
\sdN{Fuller details are in the appendices found in the accompanying material.}
