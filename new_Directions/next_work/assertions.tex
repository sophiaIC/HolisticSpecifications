...
\kjx{can we please get rid of quote marks here?\red{How do we indicate that object-capability assertions is not a standard term? Or do we not need to indicate that?}}
...
\susan{I think standard shouldn't look special and object-capability assertions should be emph the first time and then plain after that.}
...
\susan{lack of eventual permission implies no effect ever?}
