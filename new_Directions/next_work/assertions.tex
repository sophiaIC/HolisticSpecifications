...
Our assertions can be %\AssertLang, 
...
Moreover,  
$\satisfiesA{M}{\sigma}{\protectedFrom{{\re}} {{\re_{o}}}}$ means that 
$\exists \alpha, \alpha_{o}. [\  \eval{M}{\sigma}{{\re}}{\alpha}\ \wedge\ \eval{M}{\sigma}{{\re_0}}{\alpha_0} \  \wedge \ 
  \satisfiesA{M}{\sigma}{\protectedFrom{{\alpha}} {{\alpha_{o}}}}\   ]$, and  $\satisfiesA{M}{\sigma}{\inside{\re}}$ means that
