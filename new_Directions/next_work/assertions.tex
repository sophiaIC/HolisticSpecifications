...
Oxbject capability assertions express restrictions of  objects' \fbox{eventual authority} on other objects.
...
\sdred{Ghost fields may be recursively defined, thus evaluation of $\re$ might}
