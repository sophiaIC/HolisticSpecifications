...
\sdN{In the object capabilities model \cite{MillerPhD}, \emph{access} to a capability (called \emph{permission} in \cite{MillerPhD}
...
One can  see that protection and protection preservation are sufficient but not necessary conditions for lack of eventual permission, and that, on the other hand, protection without preservation of protection does not imply lack of eventual permission.
}
