...
\sdN{Lack of eventual access is a central concept in the verification of code with calls to and callbacks  from untrusted code.
...
restrictive) than most of these approaches,
 \sdN{although more restrictive than the ideal "lack of eventual access"}. 
