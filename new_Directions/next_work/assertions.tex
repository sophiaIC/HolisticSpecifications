...
$\satisfiesA{M}{\sigma}{\protectedFrom{{\re}} {{\re_{o}}}} \ \ \ \triangleq $ \\
 ...
 \ \  ]$
 \end{enumerate}
 \sdN{NEW, PROPOSED DEFINITION; assume that we have values $\beta$, which include addresses, $\alpha$, and literals $\lambda$
  \begin{itemize}
  \item
 $\satisfiesA{M}{\sigma}{\protectedFrom{{\beta}} {{\beta_{o}}}}   \ \ \ \triangleq $ 
  \begin{itemize}
  \item
 $  \exists  \lambda_o$ such that $\beta_o =\lambda_o$,  
 
 or
 
  \item
$  \exists \alpha,   \alpha_o,$ such that $\beta =\alpha$, and $\beta_o =\alpha_o$, and
  \begin{itemize}
   \item
$\alpha\neq \alpha_o$,
 \ \ \ \  and% \\
...
\item
$\satisfiesA{M}{\sigma}{\protectedFrom{{\re}} {{\re_{o}}}} \ \ \ \triangleq $ \\
  $\exists \beta, \beta_{o}. [\  \ \eval{M}{\sigma}{{\re}}{\beta}\ \wedge \eval{M}{\sigma}{{\re_0}}{\beta_0} \  \wedge \ 
  \satisfiesA{M}{\sigma}{\protectedFrom{{\beta}} {{\beta_{o}}}}
 \ \  ]$
 \end{itemize}
...
\end{itemize}
\item
 $\satisfiesA{M}{\sigma}{\protectedFrom{{\beta}} {{\lambda_{o}}}}   \ \ \ \triangleq  \ \ \ true$
 \item
 $\satisfiesA{M}{\sigma}{\protectedFrom{{\lambda}} {{\alpha_{o}}}}   \ \ \ \triangleq  \ \ \ false$
  \item
$\satisfiesA{M}{\sigma}{\protectedFrom{{\re}} {{\re_{o}}}} \ \ \ \triangleq $ \\
  $\exists \beta, \beta_{o}. [\  \ \eval{M}{\sigma}{{\re}}{\beta}\ \wedge \eval{M}{\sigma}{{\re_0}}{\beta_0} \  \wedge \ 
  \satisfiesA{M}{\sigma}{\protectedFrom{{\beta}} {{\beta_{o}}}}
