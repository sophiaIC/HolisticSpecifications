...
\footnoteSD{\red{TO DISCUSS: What is the underlying Hoare logic also has rules for internal calls? SD thinks that this is Ok, because we require the logic to be sound. This could mean that the underlying Hoare logic does not support arguments about protection.} 
}
...
\begin{array}{l}
\inferruleSD 
{~ \strut \hspace{6.5cm} {\sc{public\_or\_private\_method}}}
{  
