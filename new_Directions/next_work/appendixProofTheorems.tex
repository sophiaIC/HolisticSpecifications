...
% and using Lemma \npgreen{\ref{l:adapt:stable} and \ref{l:shallow:scoped} part \ref{fiveSD}}, and \npgreen{because $\overline z \cap \overline y = \emptyset$}   we obtain \\
...
% It uses  Lemmas
% \ref{lemma:push:ass:state} part \ref{lemma:push:ass:state:one}, then \ref{lemma:external_exec_preserves_more}, part (3),  and   \ref{l:adapt:stable} and \ref{l:shallow:scoped}
