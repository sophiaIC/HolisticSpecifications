...
\npgreen{$\SPS (14) \ \   M,  {\sigma_1}  \models  {\Aop[\overline{\alpha/z}][\overline{\interpret{\sigma}{v_6}/v_6] }}$}. \\
...
\\ 
$\SPS (18) \ \  \satDAssertFrom M  {\sigma_1'} {\npgreen{\DepthSt {\sigma_1} }}    {(A_{post})[\overline{\alpha/z}][\overline{\interpret {\sigma} {v_6} /v_6}]}$.
\\
...
\\
 From (16) we obtain that  $ \DepthSt {\sigma_1'} = \DepthSt {\sigma_1}$. This, together with (18) gives 
  \\
$\SPS (19c) \ \  \npgreen{ M , {\sigma_1'} \models  {(A_{post})[\overline{\alpha/z}][\overline{\interpret {\sigma} {v_6} /v_6}]}}$.
\\
