...
\\
$\SPS (11a) \ \  \overline {v_1} \triangleq \overline y$, \ \ $\overline {v_2} \triangleq  \prg{this}$, \ \ $\overline {v_3} \triangleq  \overline z$,\ \ $\overline {v_6} \triangleq  y_0 $, \ \  $\overline {v_4} \triangleq  \fv(A)\setminus \{  \overline {v_1},  \overline {v_6}, \overline z \}$,  
...
\\
$\SPS (11b) \ \  \fv(A)=\overline {v_1}, \overline {v_6}, \overline{v_3}, \overline{v_4}$
\\
We define $A_0$ as \\
$\SPS (12) \ \  A_0 \triangleq  \prg{this}:D,\overline{y:D}\, \wedge\, A_{pre}$\\
Then, we have that\\
$\SPS (12a) \ \  A \txteq A_0[\overline {v_6/v_2}]$, \ \ \ \ 
and\\
$\SPS (12b) \ \  \fv(A_0)=\overline {v_1}, \overline {v_2}, \overline{v_3}, \overline{v_4}$.
\\
From (12) - (12b),  and (4) we see that the requirements  \ref{l:calls:r:one}-\ref{l:calls:r:four} of Lemma \ref{l:calls}  are satisfied for $A_0$.
  Therefore, with     Lemma   \ref{l:calls} part \ref{l:calls:callee:one} we obtain\\
$\SPS (13) \ \  \satDAssertFrom M  {\sigma_1} {k}   {(\prg{this}:D,\overline{y:D}\, \wedge\, A_{pre})[\overline{\alpha/v_3}][\overline {\interpret {\sigma} {v_4}/v_4} ] }$.
...
$\fv(\prg{this}:D,\overline{y:D}\, \wedge\, A_{pre})  \setminus dom(\sigma_1)$.  We do this below. From (8a) we have that\\
$\SPS (16) \ \  dom(\sigma_1)=\{ \prg{this}, \overline y \}$.\\
This, with (11a) and (12b) gives that\\
$\SPS (16a) \ \  \fv(\prg{this}:D,\overline{y:D}\, \wedge\, A_{pre})  \setminus dom(\sigma_1) = \overline {v_3}, \overline {v_4}$.\\
We now apply the induction hypothesis on  (9), (10), (13),   (14), and (16a), and obtain
\\ 
$\SPS (17) \ \  \satDAssertFrom M  {\sigma_1'} {k}   {(A_{post})[\overline{\alpha/v_3}][\overline{\interpret {\sigma_1} {v_4} /v_4'}]}$.
\\
We now want to apply  \ref{l:calls} part \ref{l:calls:caller:one}. For this, we take
\\
$\SPS (19a) \ \  \overline {v_1} \triangleq \overline y$, \ \ \ \ $\overline {v_2} \triangleq  \prg{this}, res$, \ \ \ \ $\overline {v_6} \triangleq  y_0, u$, \\ $\overline {v_5} \triangleq  \prg{u}$, and
