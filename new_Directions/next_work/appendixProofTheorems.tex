...
$\overline {v_2} \triangleq  \fv(A)\setminus \overline {v_3}$ %,\overline {v_2})$.
...
\\
$\SPS (12b) \ \  \fv(\Ao)=\overline {v_1}, \overline {v_2}$,
\\
$\SPS (12c) \ \  \fv(A)\ =\overline {v_3}, \overline {v_2}$.
\\
Furthermore, (8a), and (12a) give that:\\
$\SPS (12d) \ \  \overline { {\interpret {\sigma_1} {v_1}} = {\interpret {\sigma} {v_3}} }$
\\
Moreover, because $y_0,\overline y \subseteq dom(\sigma)$, and by (3), we obtain that $\overline z \subseteq \overline {v_2}$. We define\\
$\SPS (12e) \ \ \overline {v_4} \triangleq  \overline {v_2}\setminus \overline {z}$
\\
Then, (4),  (12a),   (12b) and (12c) give that\\
$\SPS (13) \ \ \satDAssertFrom M  {\sigma} {k}   {\Ao[\overline{v_3/v_1}][\overline{\alpha/z}]][\overline{\interpret{\sigma}{v_4}/v_4}]}$
\\
From (4), (8a), (12a) - (12c),   we see that the requirements  %\ref{l:calls:r:one}-\ref{l:calls:r:four} 
 of Lemma \ref{l:calls}  are satisfied for $\Ao$.
  Therefore, with     Lemma   \ref{l:calls} part \ref{l:calls:callee:one}, and (12a) we obtain\\
$\SPS (14) \ \  \satDAssertFrom M  {\sigma_1} {k}   {\Ao[\overline{\alpha_3/v_3}][\overline {\interpret {\sigma} {v_4}/v_4} ] }$. \\
...
This, with (12), (12b), (12d), and (14)  gives that\\
...
\\
We now apply the induction hypothesis on (14), (16), (15c), and (12e), and obtain
\\ 
$\SPS (18) \ \  \satDAssertFrom M  {\sigma_1'} {k}   {(A_{post})[\overline{\alpha_3/v_3}][\overline{\interpret {\sigma} {v_4} /v_4}]}$.
\\
...
$\SPS (19a) \ \  \fv({\Ao}_{,a}) \subseteq  \overline {v_{1,a}}, \overline {v_{2,a}}$
\\
...
\\
$\SPS (20) \ \  \satDAssertFrom M  {\sigma'} {k}   {{\Ao}_{,a}[\overline{v_{1,a}/v_{3,a}}][\overline{\alpha_3/v_3}][\overline{\interpret {\sigma} {v_4} /v_4}][\overline {v_6'/ v_2'}]}$.
\\
