...
%M \vdash  \quadruple { \ \prg{this}:D,\overline{y:D}\, \wedge\, A_{pre}\  } {\ stmt_m } {\ A_{post}\ } {A_{mid}}$.\\
From (8) we obtain\\ % and (9) we obtain  \\
$\SPS (11) \ \ (\Ao,\sigma_1,A_{post}, A_{mid}) \ll_{M,\Mtwo} (A,\sigma,A', A'')$
%(\prg{this}:D,\overline{y:D}\, \wedge\, A_{pre},\sigma_1,A_{post}, A_{mid}) \ll_{M,\Mtwo} (A,\sigma,A', A'')$. 
\\
...
% {(\prg{this}:D,\overline{y:D}\, \wedge\, A_{pre})[\overline{\alpha/v_3}][\overline {\interpret {\sigma} {v_4}/v_4} ] }$.
...
$\fv(\Ao
%\prg{this}:D,\overline{y:D}\, \wedge\, A_{pre}
...
$\SPS (16a) \ \  \fv(\Ao %\prg{this}:D,\overline{y:D}\, \wedge\, A_{pre}
