...
\item
$\satisfiesAK{M} \sigma k {\obeys \re S}$ is defined by cases
\begin{itemize}
\item
$\satisfiesAK{M} \sigma  0 {\obeys \re S}  \ \ \ \triangleq \ \ \   \exists \alpha. \eval{M}{\sigma}{{\re}}{\alpha}$
\item
$\satisfiesAK{M} \sigma  {k+1} {\obeys {\re} {S}}  \ \ \ \triangleq \ \ \   \satisfiesAK{M} \sigma {k} {\obeys {\re} {S}} \wedge \forall pol \in S.[ 
\satisfiesAK{M}\sigma  {k} {\obeys {\re} {pol}}$
\end{itemize}
\item
For policies, $pol$ satisfaction is defined by cases
\begin{itemize}
\item
...
\begin{itemize}
\item
 $ \satisfiesAK{M} \sigma {k} {\obeys {\re} {S}} $
 \item
$ the pol after k steps for k $
\end{itemize}
\end{itemize}
\end{itemize}
\end{enumerate}
