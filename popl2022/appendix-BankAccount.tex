...
In \ModD,   the balance 
of an account \sd{is kept} in a ledger \sd{rather than in the account itself}, and \sd{and therefore
the lookup of the balance requires a ghost field, which is recursively defined.} 
 Thus, 
...
\sd{Informally, these classical specifications}
  state that 
\begin{description}
