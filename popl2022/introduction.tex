...
a call to the method \prg{transfer} with the right password passed in. 
...
With this, we can leverage Hoare triples to reason \sd{about any call  to one particular method }.  
