...
With \SrobustB, I can confidently pass my account to some untrusted client who
 ...
 know they will not  {be able to} steal my money \cite{ooToSecurity,miller-esop2013}. \jm[``I can pass my password to any context where my password isn't known'']{}
...
\item \susan[]{Three novel \Nec operators (\S\ref{intro:this:work}) that combine implication and temporal operators. }
 \item
A language to
