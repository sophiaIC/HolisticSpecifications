...
\susan[]{This work introduces \Nec with its specification language for expressing a module's safety guarantees, such as (***) and its logic
%is  the first to express necessity specifications, including those like (***), and also
to prove adherence to such specifications.
We have been inspired by   \emph{Chainmail}'s approach to add capability operators, but simplified it, removing temporal operators and introducing necessity operators. These simplifications enabled us to develop our proof logic.}
