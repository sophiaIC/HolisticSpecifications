...
-- to paraphrase \citeasnoun{Lamport77}  
...
the code (e.g.\ calll the \prg{transfer} function)
%) 
...
However, while guarantee (S2) is   necessary \sophiaPonder[dropped: condition]{}  to confidently pass 
 ...
 \sophiaPonder[drop: or what if the module allows me to install a new 
...
With (S3), I can confidently pass my account to some untrusted client who
 ...
 balance, and a password.
  ...
  Both {\sc{VerX}} and  \emph{Chainmail} can express (S2) but
