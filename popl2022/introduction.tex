...
\prg{Mod1}. The catch is the \jm[]{vulnerability} \prg{Mod2} is the result
...
expressed in terms of observable effects \jm[]{and the shape of the heap --- the account balance is reduced 
