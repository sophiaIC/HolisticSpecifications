...
There has been work in the past to expand specifications of systems beyond the specification of good things.  blah, blah, blah  \sophia[JAMES BRING IN HERE THE OTHERS, and in particular Gordon's correspondence assertions also say that type systems are also about bad things
do not happen]{} \citeauthor{FASE} were also concerned with 
...
from an $A_2$-state to and $A_3$-state.\sophia[Shall we also talk of onlyIf1, and onlythrough? I vote no]{}
...
Our assertions $A$ allow for the usual logical connectives and quantifiers
 ...
 And Access (or permission in Miller's work \sophia[need citation here]{}) is relevant because in general,
...
\end{minipage} 
 \end{tabular}
  \caption{class \prg{Account} version II,  \ \ \ \ \ \hspace{.7in} \ \ \ \ \ \  class \prg{Account} version III}
