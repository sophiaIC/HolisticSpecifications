...
with arbitrary, unknown code.  
 ...
 More recently,  {\sc{VerX}} [\citeauthor{VerX}] and   \emph{Chainmail}  [\citeauthor{FASE}]
 added temporal operators to specification languages.
 {\sc{VerX}} is used to express safety properties of smart contracts;
...
\vspace{.03in}
Our work is concerned with the safety of \susan[need something to differentiate our work from previous work]{high level typed modules},
%a module, 
