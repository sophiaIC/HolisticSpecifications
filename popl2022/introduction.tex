...
\sd{guarantees} that it is not possible to  take money out of the account through some method other than \prg{transfer}
...
\Nec is the first approach that is able to \susan[]{both} express and prove
...
\\
\susan[replaced an onlyIf with an onlyThrough]{}
$ 
...
We faced the challenge  how to develop a logic that would enable us to prove that code 
 adhered to  specifications \sd{talking of system-wide properties.} The Eureka moment was the realisation that all the information we required was hiding \susan[before I spoke of programs and functions rather than modules and methods]{ in the individual methods' classical specifications.}
