...
A proof in our logic % the bank account 
  that our bank module obeys the \Nec specification \SrobustB (\S\ref{s:examples}),     mechanised in Coq.
  And a proof that
  a richer bank module which uses ghostfields and internal classes  obeys  \SrobustB (\S\ref{app:BankAccount}),
