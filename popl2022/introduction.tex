...
\sd{Earlier works addressing robustness} includes object capabilities  \cite{MillerPhD, dd, threoremsFreeSep}, 
...
\sd{Most of these  works propose \emph{generic} robustness guarantees -- \emph{e.g.} no dependencies from high values to low values) --
