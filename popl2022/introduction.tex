...
\item \susan[]{Three novel necessity operators (\S\ref{intro:this:work} ) that combine implication and temporal operators. }
 \item
A language to
...
\item \susan[]{Examples taken from the literature  (\S\ref{s:expressiveness} and \S\ref{a:necSpec}) specified in \Nec  .}
