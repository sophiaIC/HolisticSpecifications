...
\end{quote}
\jm[]{While \SrobustA specifies how the outside world may reduce our bank 
balance, \SrobustB describes the conditions under which we can be assured that 
our bank balance is safe from malicious code.}
