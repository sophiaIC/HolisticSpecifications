...
For example, consider the \prg{Account} class in module \prg{Mod1}
...
express necessity specifications. 
 \item
a logic proving a module's adherence to its
necessity specifications
%% This logic builds on top of classical pre- post- conditions.
\item
  a Coq proof of soundness of the logic
\item
  a Coq proof of the bank account example 
\end{enumerate}
