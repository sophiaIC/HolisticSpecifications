...
\susan[Is it better to just omit the cite of Lamport?]{- broadly paraphrasing \cite{Lamport77} on liveness and safety. }
...
First,  the fact that necessity operators are second class, allows us to 
 ...
 Second, assertions may be \emph{internal}, \textit{i.e.,}
...
per-method
 \Nec specifications and internal assertions 
