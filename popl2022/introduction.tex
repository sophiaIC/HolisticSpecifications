...
\vspace{.07in}
 {
The \sd{first main} contribution  
...
Using this operator, 
\sophiaPonder[chopped "and Chainmail's capability operators that we have adopted into 
\Nec]{we} 
...
Unlike  \emph{Chainmail}'s temporal operators, 
 ...
 obeys \Nec specifications. \sophiaPonder[chepped "talking of system-wide properties.", as it might be unclear]{}
\sd{Our insight was  that \Nec specifications are logically equivalent to the
...
\sd{We addressed that  challenge} through three further insights: 
 \sophiaPonder[slight reworded Julian's part]{(1) \Nec specifications of emergent behaviour can be built up from \Nec specifications of
 ...
 (3) in turn can be \sd{obtained} from \emph{traditional} \funcSpecs.}
 %
