...
\begin{tabular}{cc}
(A) &
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=8mm,
                    thick,
	...
	\node[internal node] (a) {1};
	\node[external node] (b) [right = of a] {2};
	\node[internal node] (c) [right = of b] {3};
	\node[external node] (d) [right = of c] {4};
	\node[external node] (e) [right = of d] {5};
	\node[internal node] (f) [right = of e] {6};
	\node[internal node] (g) [right = of f] {7};
