\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=9mm,
                    thick,
                    external node/.style={circle,draw,minimum size=7mm,font=\sffamily\Large\bfseries, color=blue},
                    internal node/.style={circle,draw,minimum size=7mm,font=\sffamily\Large\bfseries, color=orange}]
...
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=9mm,
                    thick,
                    external node/.style={circle,draw,minimum size=7mm,font=\sffamily\Large\bfseries, color=blue},
                    internal node/.style={circle,minimum size=7mm,font=\sffamily\Large\bfseries, color=orange}]
    
	\node[external node] (a) {1};
	\node[internal node] (b) [right = of a] {};
	\node[external node] (c) [right = of b] {3};
	\node[external node] (d) [right = of c] {4};
	\node[internal node] (e) [right = of d] {};
	\node[internal node] (f) [right = of e] {};
	\node[external node] (g) [right = of f] {7};
	\node[internal node] (h) [right = of g] {};
	\node[external node] (i) [right = of h] {9}; 

	\path[every node/.style={font=\sffamily\small}]
		(a) edge[bend left] node [above] {} (c)
		(c) edge[bend left] node [above] {} (d)
		(d) edge[bend left] node [above] {} (g)
		(g) edge[bend left] node [above] {} (i);
\end{tikzpicture}