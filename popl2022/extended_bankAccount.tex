...
\jm[]{}\sophiaPonder[said: We rewrite]{} The \texttt{NecessityBankSpec} will use the ghost field, \texttt{balance},
and not simply the balance field as in \texttt{Mod1}, \texttt{Mod2}, and \texttt{Mod3}. 
\begin{lstlisting}[language=Chainmail, mathescape=true, frame=lines]
NecessityBankSpec $\triangleq$ from b:Bank $\wedge$ b.balance(a)=bal 
