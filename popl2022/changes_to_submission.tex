...
\item[7] We have included an \prg{init} method
for initializing the password. As we discussed with the 
reviewers, allowing a mechanism to obtain the password
would violate the intention of the \prg{Account}.
  \end{description}
...
\subsection{Reccomended Changes}
