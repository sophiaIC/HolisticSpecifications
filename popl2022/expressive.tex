...
\jm[The high profile, high money losses in the smart contract world have made ensuring that smart contracts cannot be attacked from outside a priority.]{} It is interesting to see how straightforward it is to state assertions that protect the exemplars from attacks that have caused grief in the past.}
...
\label{fig:DOM}
\end{figure}
\jm[TODO: add more specific description of the image of the DOM on the right]{}
