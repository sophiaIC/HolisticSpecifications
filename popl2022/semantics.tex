...
\jm[I moved adaptation here because it didn't really fit in 3.2]{\Nec specifications refer to program state at muiltiple points in time, which introduces the 
