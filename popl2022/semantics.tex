...
can be related by strength. An \emph{Only If} ($\onlyIf{A_1}{A_2}{A}$) implies
...
of the execution. This relationship can be better observed when we 
...
\item[Only Through:] $\onlyThrough{A_1}{A_2}{A}\ \equiv\ A_1\ \wedge\ \Diamond A_2\ \longrightarrow\ A\ \vee \Diamond (A\ \wedge (A_2\ \vee\ \Diamond A_2))$
\end{description}
}
...
%
\kjx{
This specifications can refers to three different program states: at
