...
the complete execution as in (a), the external state execution as seen from
one module as in (b), and the external state execution as seen from the other
module as in (c).
}
...
the class of the variable $x$ in the heap of $\sigma$.} 
