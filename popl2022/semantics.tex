...
In this Section we define the syntax (Dwf. \ref{f:holistic-syntax}) and semantics (Def. \ref{d:necessOpers})
of
...
$\bullet$ \ $\satisfies{M}{{A}}$ \ \ \ iff\ \ \ for all $M'$, $\sigma$,\ if $\arising{M}{M'}{\sigma}$, then $\satisfiesA{M}{\sigma}{A}$.\\
