...
$\proves{M}{A}$, to prove  satisfaction of assertions. 
 We will not define such a judgment, but will rely on its existence \sd{later on for} Theorem \ref{thm:soundness}.
...
A judgment of the form \sophiaPonder[used to say $\proves{M}{A}$]{$M \vDash A$} is \emph{sound}, if for all
