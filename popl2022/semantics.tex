...
%Program 
Execution is performed in the context of a module $M$,
which is a mapping
from class names to class definitions. 
Execution has the format  $M, \sigma \leadsto \sigma'$, has a small-step semantics, and is
unsurprising,  c.f. Appendix \ref{app:loo}.
The statements being executed are those in the continuation of the top frame.
 % chopped, as generic 
