...
\sd{In order to give semantics to \Nec operators we need the auxiliary concept 
of adaptation.}
...
\sophiaPonder[Julian, you wrote "Adaptation may seem complex, however ...." I find such sentences "defeatist" -- propose we remove it. yes?]{}

%\jm[]{ Consider the a program state where 
%\prg{x.f = 5}.
