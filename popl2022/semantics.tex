...
\jm[]{In Definition \ref{def:arising} We also use the notation $\reductions{M_1}{M_2}{\sigma}{\sigma'}$ to denote
...
\jm[]{Finally, \Loo has a simple class based type system with the following properties:
\begin{description}
\item[(1)]
...
\jm[]{\Chainmail extends \SpecO with novel 
\emph{Necessity Specifications}.}
In this Section we define \jm[]{the syntax (Fig. \ref{f:holistic-syntax})} and semantics of
\emph{Necessity Specifications}.
We have three forms of Necessity Specifications, \jm[]{defined in Fig. \ref{f:holistic-syntax}}, and described below:
