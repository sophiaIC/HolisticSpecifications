...
Like \Chainmail Chainmail is able to express specifications of \emph{permission}, \emph{viewpoint}, and \emph{control}, however we 
...
using the novel Logic of Necessity presented in this paper. 
We also do not include assertions about \emph{space},  as they are not required for either the definition 
of our Necessity Logic, or expressing their examples (see Section \ref{s:examples}). 
Chainmail lacks an inference system.
...
\susan[]{This paragraph needs a rewrite.}\Chainmail\ differs from Swasey, Schaefer's, and Devriese's work in a number of ways:
...
\paragraph{Blockchain}\susan[I think Scilla should be dropped]{}
