...
\cite{FASE}'s \emph{Chainmail} is a specification language for open world systems with necessary conditions.
Like \Chainmail, Chainmail is able to express specifications of \emph{permission}, \emph{provenance}, and \emph{control}. Unlike \Nec, \emph{Chainmai}l  has a rich set of temporal operators and  includes assertions about \emph{space}. However we 
...
of our logic, or expressing the \emph{Chainmail} examples (see Section \ref{s:examples}). 
