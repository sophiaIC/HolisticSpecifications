...
\jm[]{\cite{sandbox} develop $\lambda_{sandbox}$, a low-level language with 
...
referred to by \cite{ddd}. \citeauthor{sandbox} address a slightly different
problem domain than \Chainmail does, low-level systems programming where 
there is a possibility forging references to locations in memory. Such a domain
