...
at states satisfying $P$ and executing   $C$ is guaranteed to reach only states that satisfy $ Q $,
 incorrectness triples $[ P_i ]\, C_i\, [ Q _i ]$ express  that starting at  
 states satisfying $P_i$ and executing  $C_i$ is guaranteed to reach 
