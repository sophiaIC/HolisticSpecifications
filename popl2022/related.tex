...
Like \Chainmail, Chainmail is able to express specifications of \emph{access}, \emph{provenance}, and \emph{control}. Unlike \Chainmail, Chainmail  has a rich set of temporal operators and  includes assertions about \emph{space}. However we 
