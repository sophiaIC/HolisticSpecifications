...
Like \SpecO, Chainmail is able to express specifications of \emph{permission}, \emph{provenance}, and \emph{control}. Unlike \SpecO, Chainmail  has a rich set of temporal operators and  includes assertions about \emph{space}. However we 
...
the onlyIf and onlyThrough operators presented in this paper.}
