...
--- effectively that the footprint of an
encapsulated assertion is completely contained within that module
...
defining module.\textbf{JULIAN / EVERYONE: IS THIS 1000\% RIGHT?}
\end{itemize}
}
