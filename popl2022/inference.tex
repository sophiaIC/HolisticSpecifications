...
\jm[]{
Specifically, a key component of constructing program wide \Nec proofs 
is the identification of properties that require internal (and thus known)
...
calls to a certain module is guaranteed not to invalidate any assertions encapsulated by that module.
 Assertion encapsulation has been used in proof systems to solve the fame problem
