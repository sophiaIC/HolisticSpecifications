...
\item
\jm[]{Part 2:} Proving Necessity Specifications from classical specifications for \jm[]{a single} internal method (Section \ref{s:classical-proof})
\item
\jm[]{Part 3:} Proving module-wide \jm[]{Single-Step} Necessity Specifications by combining per-method Necessity Specifications (Section \ref{s:module-proof})
\item
...
As already stated in Section \ref{s:outline}, the first step in proving adherence to Necessity Specifications
...
\subsection{\jm[]{Part 2:} Per-Method Necessity Specifications from Classical Specifications}
...
\subsection{\jm[]{Part 3:} Necessity Specifications for Any Single Step}
...
%
\subsection{\jm[]{Part 4:} Necessity Specifications for Emergent Behaviour}
