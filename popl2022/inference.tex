...
\jm[]{We define a rudimentary system for proving encapsulation in Appendix \ref{s:encap-proof}.}
\jm[]{This rudimentary encapsulation system employs the footprint of an assertion
annotations on classes to restrict
