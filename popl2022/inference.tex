...
\end{figure}
\jm[TODO: add paragraph describing \textsc{If1-$\exists_1$}, \textsc{If1-$\exists_2$}, \textsc{$\exists_1$}, \textsc{$\exists_2$}, \textsc{If-$\exists_1$}, and \textsc{If1-$\exists_2$}]{}
...
\jm[]{There are two rules for existential elimination on the left hand side.
...
\jm[]{Both relations also include rules for existentials on the left hand side ($\exists_1$, $\exists_2$, \textsc{If-$\exists_1$}, and \textsc{If-$\exists_2$}).
