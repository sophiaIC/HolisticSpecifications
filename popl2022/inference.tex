...
\jm[]{
\textsc{If1-Wrapped} is a specialized version of \textsc{If1-Classical}
...
for leaking of data. \textsc{If1-Wrapped} rather states that if $P$ is
...
% \textsc{If1-Intrnl} states that if we are able to prove that $P$ is 
