...
\jm[]{Section \ref{s:approach} provides a high level outline for how proofs of
\Nec specifications are constructed. The outline in Section \ref{s:approach} 
was top down, from proofs of emergent behavior, down to proofs of which functions
