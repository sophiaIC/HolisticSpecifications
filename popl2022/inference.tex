...
\infer
		{}
		{
		M,\ \Gamma\ \vdash \calls{\alpha_1}{\alpha_2}{m}{\overline{v}}\ \longrightarrow\ \external{\alpha_1}
		}
...
\infer
		{}
		{
		M,\ \Gamma\ \vdash \calls{\alpha_1}{\alpha_2}{m}{\overline{v}}\ \longrightarrow\ \access{\alpha_1}{\alpha_2}
		}
...
\infer
		...
		{
		M,\ \Gamma\ \vdash \alpha : C\ \longrightarrow\ \wrapped{\alpha}
		}
...
%	M,\ \textit{Env}(A) \vdash\ \encaps{e}\\
	...
	M\ \vdash\ \onlyIfSingle
			{A\ \wedge\ P_1\ \wedge\ \calls{\_}{\alpha}{m}{\overline{v}}}
			{\neg P_2}
			{P}
	}
