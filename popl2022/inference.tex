...
\jm[]{In Sec. \ref{s:outline} we identified proof of assertion encapsulation
as \textbf{Part 1} of proving adherence to a \Nec specification.
Sec. \ref{s:semantics:encaps} defined the semantics of assertion encapsulation.
