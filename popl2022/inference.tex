...
\infer
		{}
		{
		M,\ \Gamma\ \vdash \calls{\alpha_1}{\alpha_2}{m}{\overline{\alpha}}\ \longrightarrow\ \access{\alpha_1}{\alpha_2}
		}
		\and
\infer
		{}
		{
		M,\ \Gamma\ \vdash \calls{\alpha_1}{\alpha_2}{m}{\ldots,\alpha_i,\ldots}\ \longrightarrow\ \access{\alpha_1}{\alpha_i}
		}
		\and
\infer
		{}
...
\infer
		...
		{
		M,\ \Gamma\ \vdash \alpha : C\ \longrightarrow\ \internal{\alpha}
		}
		\and
\infer
		{
		...
		{
		M,\ \Gamma\ \vdash e : C\ \longrightarrow\ e.f : D
		}
		\and
\infer
		{
		...
		{
		M,\ \Gamma\ \vdash \alpha : C\ \longrightarrow\ \forall x.[\internal{x}\ \vee\ \neg \access{x}{\alpha}]
		}
\end{mathpar}
...
\infer
	...
	M\ \vdash\ \onlyIfSingle
			{A\ \wedge\ e\ \calls{\_}{\alpha}{m}{\overline{v}}}
			{\neg e}
			{P}
	}
...
\infer
	...
	{M\ \vdash\ \onlyIfSingle{\wrapped{\alpha'}\ \wedge\ \calls{\_}{\alpha}{m}{\overline{v}}}{\neg \wrapped{\alpha'}}{P}}
	\quad(\textsc{If1-Wrapped})
	\and
\infer
	{
	\{m_1, \ldots, m_n\}\ \textit{are all the methods in}\ M\\
	\forall i\ \in\ 1 \ldots n,
				M\ \vdash\ \onlyIfSingle
								{\neg A_1\ \wedge\ \calls{\_}{\alpha}{m_i}{\overline{\alpha}}}
								{A_1}
								{A_2} \\
	M\ \vdash\ A_1\ \longrightarrow\ \neg A_3\\
	M,\ \textit{Env}(A_1)\ \vdash\ \encaps{A_3}
	}
	{
	M\ \vdash\ \onlyIfSingle{A_1}{A_3}{A_2}
	}
