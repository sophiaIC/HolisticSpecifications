...
\item
\jm[]{Classes may be optionally annotated as \enclosed: their instances (``\enclosed'' objects) are marked as \enclosed may not be returned by methods of non-\enclosed classes.}
\item
