...
We introduce \Loo, a simple, typed, class-based, object oriented language that underlies the \NecessitySpecifications
...
\item
Classes may be annotated as \prg{inside} or \prg{boundary}, and objects of \prg{inside} classes may not be returned by methods of \prg{boundary} classes.
\item
