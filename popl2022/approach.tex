...
%humans think about proofs. 
This section aims to provide a perspective of the 
structure of 
\Nec logic, and roughly follows the three breakthroughs identified in \S\ref{intro:this:work}
with a minor reorganisation: assertion encapsulation is separated 
out as a distinct part from proofs of single-step conditions. With this reorganisation,
\Nec logic consists of 4 parts:
\begin{description}
