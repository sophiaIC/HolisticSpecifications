...
Finally, we define the syntax and semantics of our \Nec specification language  (\S \ref{s:holistic-guarantees}).
...
Here we introduce the concepts most relevant to the
...
In Definition \ref{def:arising}, we also use the notation $\reductions{M}{M'}{\sigma}{\sigma'}$ to denote
