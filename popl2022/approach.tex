...
we \sd{revisit} our running example, the Bank Account (\S\ref{s:bank}),   \sd{give 
the \Nec specs} (\ref{s:bankSpecEx}),
...
\ModC.  For this we will be using  on of the  three necessity operators mentioned in  \S \ref{intro:this:work}. These operators are:}
\\
