...
\Nec logic, and follows the three breakthroughs identified in \S\ref{intro:this:work}
...
classical pre and postconditions are used to infer per-method conditions. 
...
\jm[]{Our system consists of four parts (five including classical specifications):
