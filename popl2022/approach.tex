...
through a pre and postconditions  JML-style\cite{Leavens-etal07}  ``classical''
specification.
...
For $M$-encapsulated effects, \susan[We haven't seen M-encaps before]{}we can infer such one-step
