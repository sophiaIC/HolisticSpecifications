...
Module \ModA consists of the \prg{Account} class with a
...
%
is enough to drain the account in \ModB without knowing the password.


 \subsection{Bank Account -- the right specification}
\label{s:bankSpecEx}

We need to rule out \ModA while permitting \ModA and
