...
\jm[add introduction to Section 2]{
In this Section we outline our work  
by giving an overview of our running example, the Bank Account (\S\ref{s:bank} and \ref{s:bankSpecEx}),
how we model the open world (\S\ref{s:concepts}), 
and finally the structure of our proof system and how we reason 
...
Our logic  
 is built on top of \jm[I feel like we need this here because this is the first time ``assertion encapsulation is specifically mentioned'']{
 ...
 We say that an assertion is encapsulated if and only if invalidation 
 ...
 \jm[split sentence introducing assertion encapsulation]{}
...
\jm[]{\Nec consists of specifications of necessary conditions and a logic for proving those specifications: parts 2, 3, and 4.
