...
The structure of the system is given in Fig. \ref{fig:dependency}.
 Classical specifications are used to prove \jm[]{per-method} specifications, which coupled with 
...
The remaining parts are assertion encapsulation (part 1) and classical specifications.}
An assertion $A$  is
...
\cite{confined}.
\jm[]{For the purposes of our examples,} classical specifications are assumed, and not 
...
\Nec (parts 2, 3, and 4) and our results are } agnostic as to how \jm[]{both assertion encapsulation and} the pre- and post-conditions \jm[]{of the classical specifications} are proven.
...
\sd{on} classical pre and post-conditions  to infer per-method conditions. }
