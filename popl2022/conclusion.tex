...
We have developed a \susan[We use logic throughout the paper and here we say we don't have our own logic]{} inference system to prove that modules meet their specifications.  Our inference system exploits the
...
\Nec inference system; we aim to consider that in further work.
