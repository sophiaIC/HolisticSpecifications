...
API calls is a potential attack.  Developers can no longer \susan[]{just} consider
...
framing: some form of \prg{modifies}-clauses or implicit dynamic frames
...
``callbacks'' out to external objects.  A better integrated model of
