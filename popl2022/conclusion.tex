...
%
\sophiaPonder[cut this, it is not the most important "Deriving per method \Nec specifications from \funcSpecs
...
\sd{In future work we want to consider more than one external module -- c.f. \S \ref{s:concepts},
