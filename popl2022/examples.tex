...
\subsection{The Bank Account Module}

\jm[]{The Bank Account defined in this section introduces several 
challenges over that defined in Sec. \ref{s:outline}. In the Bank Account defined in this section, we separate the balance 
...
\jm[]{We now rewrite \texttt{NecessityBankSpec} to use the ghost field, \texttt{getBal},
...
%\clearpage
\subsection{A: Assertion Encapsulation}
\label{s:BA-encap}
...
\subsection{B: Per-Method \Nec Specifications}
...
\subsection{C: Per-Step \Nec Specifications}
...
\endproofsteps
\end{proofexample}
\subsection{D: Emergent \Nec Specifications}
