...
As we have stated in Sec. \ref{sub:SpecO}, 
...
rules that under such a logic should be sound in Fig. \ref{f:assertProperties}. 
...
the overall proof follows the outline of our reasoning given in Sec. \ref{s:approach}:
\begin{description}
\item[Part 1:]
