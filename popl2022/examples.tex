...
\jm[removed repeat of \ModC]{}%We recall \ModC in Fig. \ref{f:ex-bank-short1}.
\jm[]{An outline of this proof has already been discussed in \S \ref{s:approach}.}
...
\label{s:BA-encap}
The first part of the proof is proving that the \prg{Account} \prg{balance}, \prg{pwd}, \jm[]{and external accessibility to the password} are 
