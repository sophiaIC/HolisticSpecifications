...
\jm[]{We now rewrite \texttt{NecessityBankSpec} to use a ghost field, \texttt{getBalance},
and not simply the balance field in \texttt{Mod1}, \texttt{Mod2}, and \texttt{Mod3}.
This further abstracts the implementation of the Bank Account from the \texttt{NecessityBankSpec}. The new 
