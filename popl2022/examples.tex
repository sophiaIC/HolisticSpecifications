...
\jm[]{The accompanying Coq formalism includes a mechanized version of this proof,
...
of the form $\proves{M}{A}$, \jm[]{denoting that in 
...
\end{mathpar}
\normalsize}
\jm[TODO: note that $M \vdash A_1 \longrightarrow A_2$ is for arising states only]{}
...
\label{f:ex-bank}
\end{figure}
We devote the rest of this section to the elaborated \jm[]{proof} of our
