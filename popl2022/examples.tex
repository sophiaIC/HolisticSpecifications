...
\paragraph{The Bank Account Module \prg{Mod4}}
\sophiaPonder[]{In this section we define \prg{Mod4}, a new Bank Account implementation, which   differs from that of Sec. \ref{s:outline}.}
\prg{Mod4} is more complex than \prg{Mod3}; \sophiaPonder[dropped: in the following  Bank Account]{} 
...
\sophiaPonder[]{The construction of proofs assertion encapsulation. Such a proof is necessary  here because
 the ghost field \prg{bal} reads several  fields. We use our 
 simple confinement system,}   captured by \enclosed classes in \Loo.
\end{description}


\jm[]{}\sophiaPonder[said: We rewrite]{} The \texttt{NecessityBankSpec} to use the ghost field, \texttt{getBal},
