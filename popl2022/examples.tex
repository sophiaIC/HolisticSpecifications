...
In this section we provide a full description of our
...
\proofsteps{\prg{BalanceEncaps}}
	...
	\end{proofexample}
		...
		{\proofstepwithrule
			{
			$\proves{\prg{BankMdl}}{\givenA{\prg{b$^\prime$ : Bank $\wedge$ a : Account $\wedge$ b : Bank $\wedge$ b.getBalance(a) = bal}}{\encaps{\prg{b.getBalance(a)}}}}$
			}{by \prg{balIntrnl}, \textsc{Enc-Intrnl}}}
\endproofsteps
\end{proofexample}
\end{minipage}
\begin{minipage}{\textwidth}
