...
\item[Part 4:]
Finally we use our \Nec logic and the results of A, B, and C, to prove the emergent behavior specified in \prg{NecessityBankSpec}.
\end{description}
...
\subsection{C: Proving Per-Step \Nec Specifications}
