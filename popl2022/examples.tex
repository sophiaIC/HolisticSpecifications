...
\end{mathpar}
\normalsize}
\jm[fixed problem with font size]{}
...
use classical specifications to prove that no method can leak the password \jm[]{or overwrite} of an account.
\jm[TODO: make clear that the explicit distinction between overwriting and leaking in the english is not present in the proof.]{}
\item[C]
...
\proofsteps{\prg{BalanceEncaps}}
	{\begin{proofexample}
		\proofsteps{\prg{aIntrnl}}
			{\proofstepwithrule
			{$\proves{\prg{BankMdl}}{\givenA{\prg{b, b$^\prime$ : Bank $\wedge$ a : Account $\wedge$ b.getBalance(a) = bal}}{\intrnl{\prg{a}}}}$}
				{by \textsc{Intrnl-Obj}}
		}
		\endproofsteps
	\end{proofexample}
	...
	{\begin{proofexample}
		\proofsteps{\prg{bIntrnl}}
			{\proofstepwithrule
			{$\proves{\prg{BankMdl}}{\givenA{\prg{b, b$^\prime$ : Bank $\wedge$ a : Account $\wedge$ b.getBalance(a) = bal}}{\intrnl{\prg{b}}}}$}
				{by \textsc{Intrnl-Obj}}
		}
		\endproofsteps
	\end{proofexample}
	...
	{\begin{proofexample}
		\proofsteps{\prg{getBalIntrnl}}
			{\proofstepwithrule
			{$\proves{\prg{BankMdl}}{\givenA{\prg{b, b$^\prime$ : Bank $\wedge$ a : Account $\wedge$ b.getBalance(a) = bal}}{\intrnl{\prg{b.getBalance(a)}}}}$}
	...
	{\begin{proofexample}
		\proofsteps{\prg{balIntrnl}}
			{\proofstepwithrule
			{$\proves{\prg{BankMdl}}{\givenA{\prg{b, b$^\prime$ : Bank $\wedge$ a : Account $\wedge$ b.getBalance(a) = bal}}{\intrnl{\prg{bal}}}}$}
				{by \textsc{Intrnl-Int}}
		}
		\endproofsteps
	\end{proofexample}
		...
		{\proofstepwithrule
			{
			$\proves{\prg{BankMdl}}{\givenA{\prg{b, b$^\prime$ : Bank $\wedge$ a : Account $\wedge$ b.getBalance(a) = bal}}{\encaps{\prg{b.getBalance(a) = bal}}}}$
